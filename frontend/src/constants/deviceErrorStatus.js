...
export const DEVICE_ERROR_STATUS_OPTIONS = [
  {
    value: DEVICE_ERROR_STATUS.PENDING,
    label: DEVICE_ERROR_STATUS_LABELS[DEVICE_ERROR_STATUS.PENDING],
  },
  {
    value: DEVICE_ERROR_STATUS.IN_PROGRESS,
    label: DEVICE_ERROR_STATUS_LABELS[DEVICE_ERROR_STATUS.IN_PROGRESS],
  },
  {
