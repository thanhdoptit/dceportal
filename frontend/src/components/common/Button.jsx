...
const Button = ({
  ...
  const variants = {
    ...
    secondary: 'bg-vietinbank-gray-light text-vietinbank-gray hover:bg-vietinbank-gray-light/90 focus:ring-vietinbank-gray',
    danger: 'bg-vietinbank-red text-white hover:bg-vietinbank-red/90 focus:ring-vietinbank-red',
    success: 'bg-green-600 text-white hover:bg-green-700 focus:ring-green-500',
    outline: 'border-2 border-vietinbank text-vietinbank hover:bg-vietinbank/10 focus:ring-vietinbank'
  };
