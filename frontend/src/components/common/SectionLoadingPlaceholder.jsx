  ...
  return (
    <div className='w-full'>
      ...
      <div className='bg-gradient-to-br from-slate-50 to-blue-50 border-2 border-dashed border-slate-300 rounded-xl p-8 text-center transition-all duration-300 hover:border-blue-400 hover:shadow-lg'>
        ...
        {/* Title */}
        <h3 className='text-lg font-semibold mb-2 bg-gradient-to-r from-slate-700 to-slate-500 bg-clip-text text-transparent'>
          {title}
        </h3>

        {/* Subtitle */}
        <p className='text-slate-500 text-sm mb-4'>Nội dung sẽ hiển thị trong giây lát...</p>
