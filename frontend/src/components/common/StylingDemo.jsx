  ...
  const columns = [
    ...
    createStandardColumns.actions('Thao tác', [
      ...
      },
      {
        ...
        type: 'default',
        className:
          'flex items-center gap-2 bg-orange-600 hover:bg-orange-700 text-white whitespace-nowrap',
      },
      {
        text: 'Xóa',
        ...
        type: 'default',
        className:
          'flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white whitespace-nowrap',
      },
    ]),
  ];
    ...
    <div className='p-6'>
      ...
      <Card title='Button Standards' style={{ marginBottom: 24 }}>
        <Space wrap>
          ...
          <ActionButton icon={<EyeOutlined />}>Chi tiết (Action)</ActionButton>

          <StatusButton status='success'>Thành công</StatusButton>

          <StatusButton status='error'>Lỗi</StatusButton>

          <StatusButton status='warning'>Cảnh báo</StatusButton>
        </Space>
      </Card>
