import {
    ...
    Select, DatePicker, Upload, Tag, Tooltip,
...
import {
    ...
    UserOutlined, ClockCircleOutlined, CalendarOutlined, FileSearchOutlined,
    PaperClipOutlined, MinusCircleOutlined, PlusCircleOutlined,
    LoginOutlined, LogoutOutlined, PlayCircleOutlined, InfoCircleOutlined,
    CloseCircleOutlined, LoadingOutlined, DownloadOutlined
...
export const TimeChangeContent = ({ change }) => {
    ...
    const timeLabel = change.field === 'checkInTime' ? 'Thời gian bắt đầu' :
        change.field === 'checkOutTime' ? 'Thời gian kết thúc' :
            'Thời gian';
