...
import { ERROR_MESSAGES, LOGIN_TYPES, RATE_LIMIT_CONFIG, ROLE_ROUTES } from '../constants/auth.js';
...
const InputField = ({ type, value, onChange, placeholder, icon, autoComplete, onKeyPress }) => (
  <div className='relative'>
    ...
    />
    <div className='absolute left-3 top-1/2 transform -translate-y-1/2 text-white/50'>{icon}</div>
  </div>
);
...
export default function Login() {
    ...
    () => (
      ...
      >
        <path
          strokeLinecap='round'
          strokeLinejoin='round'
          d='M12 11c1.657 0 3-1.343 3-3S13.657 5 12 5s-3 1.343-3 3 1.343 3 3 3zm0 2c-3.314 0-6 2.686-6 6h12c0-3.314-2.686-6-6-6z'
        />
      </svg>
    ),
    []
  ...
  return (
    ...
    >
      ...
      <div className='absolute top-0 left-0 right-0 h-16 bg-white/5 backdrop-blur-sm flex items-center px-4'></div>
