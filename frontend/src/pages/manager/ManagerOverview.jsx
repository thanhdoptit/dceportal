...
const ManagerOverview = () => {
  ...
  const ProgressCard = ({ title, percent, color, loading }) => (
    <Card variant='outlined' className='hover:shadow-lg transition-all duration-300'>
      ...
      <Progress percent={percent} strokeColor={color} showInfo={false} className='mt-4' />
  ...
  return (
    <div className='space-y-6'>
      <div className='flex justify-between items-center mb-6'>
        ...
        <RangePicker value={dateRange} onChange={setDateRange} className='w-80' />
      </div>
        ...
        <Row gutter={[16, 16]} className='mt-6'>
          ...
          <Col xs={24} md={8}>
            <ProgressCard
              ...
              percent={
                Math.round(
                  (stats.completedHandovers / (stats.completedHandovers + stats.pendingHandovers)) *
                    100
                ) || 0
              }
              color='#13c2c2'
