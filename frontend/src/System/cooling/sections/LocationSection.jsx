  ...
  return (
    <section id='section-3' className='content-section'>
      ...
      <div id='section-3-1' className='subsection'>
        ...
        <Card
          title='Vị trí chi tiết của từng dàn nóng hệ thống điều hòa'
      ...
      <div id='section-3-2' className='subsection'>
        ...
        <Card title='Tổng quan hệ thống điện' style={{ marginBottom: '20px' }}>
          <Paragraph>
            Hệ thống điện cho điều hòa được phân bố tại các vị trí khác nhau trong tòa nhà để đảm
            bảo cung cấp điện ổn định cho từng khu vực.
          </Paragraph>
        </Card>
          ...
          <Table
            dataSource={[
              // Thêm nhiều ảnh cho vị trí này bằng cách dùng mảng images thay vì 1 trường image
              {
                ...
                images: ['/cooling/attong1.jpg', '/cooling/attong2.jpg'],
              },
              {
                key: '2',
                location: 'Tầng hầm',
                description:
                  'Vị trí Át cấp điện cho 3 điều hòa Uniflair TDAV2842A phòng cuối hành lang + 3 điều hòa FM40H phòng PCCC + 4 điều hòa INROW PMC1 + 6 quạt thổi sàn PMC1',
                equipment: 'TDAV2842A, FM40H, INROW PMC1, Quạt thổi sàn PMC1',
                images: ['/cooling/attangham1.jpg', '/cooling/attangham2.jpg'],
              },
              {
                key: '3',
                location: 'Tầng hầm',
                ...
                images: ['/cooling/atips1.jpg', '/cooling/atips2.jpg'],
              },
              {
                key: '4',
                location: 'Phòng UPS',
                description:
                  'Vị trí Át cấp điện cho 2 điều hòa TDAV1321A phòng UPS và 3 điều hòa TDAV2242A ở phòng PMC1 + 2',
                equipment: 'TDAV1321A, TDAV2242A',
                images: ['/cooling/atups1.jpg', '/cooling/atups2.jpg'],
              },
              {
                key: '5',
                location: 'Phòng UPS',
                ...
                images: ['/cooling/atquat1.jpg', '/cooling/atquat2.jpg'],
              },
            ]}
            columns={[
              {
