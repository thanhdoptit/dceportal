  ...
  return (
          ...
          <Table
            dataSource={[
              ...
              },
              {
                ...
                description: 'Bao gồm lưới sàn chịu lực phía trên và các cánh đảo gió có thể điều chỉnh để hướng luồng khí'
              },
              {
                key: '5',
        ...
        <Card title="Thông số kỹ thuật" style={{ marginBottom: '20px' }}>
          <Table
            dataSource={[
              ...
              { key: '6', spec: 'Kích thước (Cao x Dài x Rộng)', value: '230 mm x 600 mm x 600 mm' },
      ...
      <div id="section-2.6.2" className="subsection">
        ...
        <Card title="Hướng dẫn lắp đặt chi tiết" style={{ marginBottom: '20px' }}>
          ...
          <Paragraph>
            Mỗi module phải được đặt trực tiếp lên kết cấu gồm bốn cột và thanh giằng của hệ thống sàn nâng. Có các tay cầm bên trong module để hỗ trợ việc đặt thiết bị vào vị trí.
          </Paragraph>

          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>Khoảng hở</Title>
          <Paragraph>
            Để đảm bảo luồng không khí, cần duy trì khoảng cách tối thiểu 150 mm từ mặt sàn bê tông (basement) đến đáy của module.
          </Paragraph>

          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>Kết nối điện</Title>
          <Alert
          ...
          <Paragraph>
            <ol>
              <li>Kiểm tra điện áp nguồn phải tương ứng với thông số trên nhãn dữ liệu của thiết bị. Điện áp phải nằm trong khoảng ±10% so với giá trị danh định</li>
              <li>Kết nối cáp nguồn vào đầu vào (màu nâu = pha; xanh dương = trung tính; vàng-xanh = đất)</li>
              <li>Kết nối các đầu dò nhiệt độ và cáp LAN vào các cổng cắm tương ứng trên bo mạch</li>
            </ol>
          </Paragraph>
        </Card>
      </div>
      ...
      <div id="section-2.6.3" className="subsection">
        ...
        <Card title="Hệ thống điều khiển" style={{ marginBottom: '20px' }}>
          <Paragraph>
            Hệ thống điều khiển sẽ tự động điều chỉnh luồng không khí do quạt tạo ra dựa trên nhiệt độ từ các đầu dò.
          </Paragraph>

          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>Bảng điều khiển</Title>
          <Table
            dataSource={[
              {
                key: '1',
              ...
              },
              {
                ...
                function: 'Nhấn giữ 5 giây để truy cập các thông số thường dùng; dùng để tắt chuông báo động'
              },
              {
                key: '4',
                component: 'Nút mũi tên Lên/Xuống',
                function: 'Dùng để xem giá trị của đầu dò 1 và 2, cuộn qua các thông số hoặc tăng/giảm giá trị khi lập trình'
              }
            ]}
            columns={[
              {
          ...
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>Thay đổi cài đặt</Title>
          <Paragraph>
            <ol>
              <li>Để thay đổi giá trị set point, nhấn giữ nút "PRG/mute" trong 5 giây</li>
              <li>Nhập mật khẩu <PasswordField password="77" label="" style={{ display: 'inline-flex' }} /> bằng các nút mũi tên</li>
              <li>Nhấn "SEL" để xác nhận</li>
              <li>Sử dụng các nút mũi tên để thay đổi giá trị và nhấn "SEL" để lưu</li>
            </ol>
          </Paragraph>

          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>Thông tin cài đặt</Title>
          <Table
            dataSource={[
              {
                key: '1',
      ...
      <div id="section-2.6.4" className="subsection">
        ...
        <Card title="Hệ thống giám sát lỗi" style={{ marginBottom: '20px' }}>
          <Paragraph>
            Thiết bị liên tục kiểm soát và kiểm tra các điều kiện báo động trong quá trình hoạt động.
          </Paragraph>

          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>Dấu hiệu cảnh báo</Title>
          <Paragraph>
            <ul>
              <li>Khi có lỗi, màn hình sẽ hiển thị một thông báo xác định loại báo động, xen kẽ với thông số hiển thị thông thường</li>
              <li>Chuông báo động sẽ kêu</li>
            </ul>
          </Paragraph>

          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>Bảng mã lỗi thường gặp</Title>
          <Table
            dataSource={[
              {
                key: '1',
                ...
                impact: 'Quá trình điều khiển bị vô hiệu hóa, đầu ra analog được xác định bởi thông số C10',
                solution: 'Tự động khôi phục ngay khi đầu dò được kết nối lại; cần reset thủ công để tắt chuông và xóa tin nhắn'
              },
              {
                key: '2',
                error: 'Er2',
          ...
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>Tắt báo động</Title>
          <Paragraph>
            Nhấn nút "PRG" một lần để tắt chuông và nhấn lần thứ hai để xóa thông báo lỗi khỏi màn hình (sau khi nguyên nhân đã được khắc phục).
          </Paragraph>
        </Card>
      </div>
      <div id="section-2.6.5" className="subsection">
        ...
        <Card title="Kiểm tra định kỳ" style={{ marginBottom: '20px' }}>
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>Kiểm tra định kỳ hàng tuần</Title>
          <Table
            dataSource={[
              {
                key: '1',
          ...
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>Kiểm tra định kỳ hàng tháng</Title>
          <Paragraph>
        ...
        <Card title="Giải quyết vấn đề" style={{ marginBottom: '20px' }}>
          <Paragraph>
            <ul>
              <li>Việc giải quyết sự cố được thực hiện nhờ màn hình điều khiển của bộ vi xử lý. Khi có báo động, hãy xem mã lỗi trên bảng điều khiển</li>
              <li>Nếu cần thiết, hãy gọi cho bên bảo trì trong hợp đồng và mô tả lỗi đang gặp phải</li>
            </ul>
          </Paragraph>
        </Card>
      </div>
