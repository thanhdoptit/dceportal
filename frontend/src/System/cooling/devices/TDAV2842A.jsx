  ...
  return (
    <div id='section-2.3' className='subsection'>
      ...
      <div id='section-2.3.1' className='subsection'>
        ...
        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
          ...
          <Paragraph style={{ marginTop: '10px', fontWeight: 'bold' }}>
            Hiện tại các điều hòa TDAV2842A đang được sử dụng để làm mát cho phòng Server 2, vị trí
            ở bên cạnh phòng Server 2.
          </Paragraph>
        </div>
          ...
          <Table
            dataSource={[
              { key: '1', spec: 'Công suất lạnh', value: '88 kW' },
              {
                ...
                value: '380V/400V/415V, 3 pha, 50Hz hoặc 1 pha 220/230V, 50Hz',
              },
              {
                key: '3',
                spec: 'Dung sai nhiệt độ cho phép',
                value: '≤ ± 1ºC (so với chuẩn 24ºC)',
              },
              ...
              { key: '7', spec: 'Môi chất làm lạnh', value: 'R410A hoặc R407C' },
              {
                ...
                value: '2200mm (C) x 2600mm (R) x 900mm (Sâu)',
              },
              {
                key: '9',
                spec: 'Máy nén (compressor)',
                value: '≥ 4 Scroll (tốc độ cố định) và ≥ 2 mạch ga',
              },
              {
                key: '10',
                spec: 'Quạt dàn lạnh',
                value:
                  '≥ 3 quạt điều khiển điện tử EC centrifugal fan (hiệu suất cao, tiết kiệm năng lượng)',
              },
              ...
              { key: '16', spec: 'Bộ phun ẩm', value: 'Điều khiển bằng vi xử lý' },
              {
                key: '17',
                spec: 'Bộ lọc bụi',
                value: 'Self-extinguishing (tuân thủ tiêu chuẩn EU4)',
              },
              {
                key: '18',
                spec: 'Van tiết lưu',
              ...
              },
              {
                ...
                spec: 'Bộ điều khiển',
                value:
                  'Màn hình LCD độ phân giải tối thiểu 64x120 pixel và phím điều khiển tại chỗ cho từng máy',
              },
              {
                key: '20',
                spec: 'Vi xử lý (microprocessor control)',
                value:
                  'Tự khởi động lại sau mất điện. Giám sát áp suất sàn nâng, nhiệt độ, độ ẩm. Ghi lưu đến 100 trạng thái lỗi. Hỗ trợ hoạt động dự phòng N+1, override các thành phần (compressor, fan, EEV)',
              },
              {
                key: '21',
                spec: 'Kết nối hệ thống',
                value: 'SNMP, Modbus, tương thích BMS (Siemens, Johnson, EcoStruxure…)',
              },
              {
                key: '22',
                spec: 'Nhóm điều khiển',
                value: 'Tối đa 10 thiết bị có thể kết nối làm việc nhóm',
              },
      ...
      <div id='section-2.3.3' className='subsection'>
        <Title level={4} style={{ color: '#1890ff', marginBottom: '12px' }}>
          <ExclamationCircleOutlined style={{ marginRight: '8px' }} /> 2.3.3. Hướng dẫn vận hành và
          kiểm tra hàng ngày
        </Title>
        ...
        <Card title='2.3.3.1. Hướng dẫn vận hành' style={{ marginBottom: '20px' }}>
          ...
          <Paragraph>
            <ul>
              ...
              <li>
                Kiểm tra trạng thái vận hành: Trên màn hình hiển thị
                <ul>
          ...
          <Paragraph>
            <ul>
              ...
              <li>
                <Text strong>Giới hạn nhiệt độ cảnh báo:</Text> ±1 °C
              </li>
              <li>
                <Text strong>Độ ẩm:</Text> 45% - 55% RH
              </li>
              <li>
                <Text strong>Giới hạn độ ẩm cảnh báo:</Text> ±5 %
              </li>
              <li>
      ...
      <div id='section-2.3.4' className='subsection'>
        <Title level={4} style={{ color: '#1890ff', marginBottom: '12px' }}>
          <ExclamationCircleOutlined style={{ marginRight: '8px' }} /> 2.3.4. Hướng dẫn xác định
          nguyên nhân lỗi
        </Title>
        ...
        <Card title='Quy trình xác định lỗi cơ bản' style={{ marginBottom: '20px' }}>
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
            Bước 1: Xem cảnh báo trên màn hình điều khiển
          </Title>
          <Paragraph>
            <ul>
          ...
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
            Bước 4: Kiểm tra máy nén và hệ thống gas
          </Title>
          <Paragraph>
            <ul>
              <li>
                Nếu "HIGH/LOW PRESSURE":
                <ul>
          ...
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
            Bước 5: Kiểm tra lỗi điều khiển & truyền thông
          </Title>
          <Paragraph>
            <ul>
              <li>
                Nếu "MODBUS/COMM ERROR":
                <ul>
        ...
        <Alert
          ...
          description={
            <ul>
              <li key='1'>
                Lỗi nghiêm trọng (gas, máy nén, bo điều khiển) → liên hệ kỹ thuật hãng Schneider
              </li>
              <li key='2'>Thường xuyên ghi nhật ký cảnh báo → giúp phát hiện lỗi định kỳ</li>
              <li key='3'>
                Không can thiệp phần mềm điều khiển cấp hệ thống (firmware) nếu không được hãng
                hướng dẫn
              </li>
            </ul>
          }
          ...
          <Table
            dataSource={[
              ...
              },
              {
                ...
                cycle: '3 – 6 tháng',
                content:
                  'Vệ sinh cánh, kiểm tra tiếng ồn, tốc độ quay, tình trạng driver điều khiển',
              ...
              },
              {
                ...
                cycle: '6 tháng',
                content:
                  'Làm sạch buồng ẩm, thay điện cực nếu bị cáu cặn, kiểm tra cấp nước và đường xả',
              ...
              },
              {
                ...
                location:
                  'Bên trong tủ điều khiển chính (control compartment), phía trên hoặc phía trước máy nén, phía sau cửa tủ điện mặt trước của thiết bị',
                cycle: '12 tháng',
        ...
        <Alert
          ...
          description={
            <ul>
              ...
              <li key='4'>
                Sử dụng vật tư tiêu chuẩn: lọc khí EU4, R410A hoặc R407C đúng áp suất, quạt EC chính
                hãng
              </li>
            </ul>
          }
