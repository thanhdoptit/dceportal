...
const TDAV2242A = () => {
  ...
  const technicalSpecs = [
    ...
    { parameter: 'Model dàn nóng', value: 'CAP2002' },
    {
      ...
      value: 'Điều hòa chính xác (precision cooling), giải nhiệt không khí (air-cooled)',
    },
  ...
  return (
    <div id='section-2.2' className='subsection'>
        ...
        <Title level={4} style={{ color: '#1890ff', marginBottom: '12px' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <Paragraph style={{ marginTop: '10px', fontWeight: 'bold' }}>
              Hiện tại các điều hòa TDAV2242A đang được sử dụng để làm mát cho phòng Server 1 và
              Server 2, vị trí ở bên trong phòng Server 1 và Server 2.{' '}
            </Paragraph>
          </div>
        </Title>
      ...
      <div id='section-2.2.2' className='subsection'>
        ...
        <Card title='Nguồn điện' style={{ marginBottom: '20px' }}>
          <Paragraph>
            <ul>
              <li>
                <Text strong>Nguồn cấp:</Text> 400V – 3 pha – 50Hz
              </li>
              <li>
                <Text strong>Dây nguồn:</Text> 5 x (4 – 10) mm² tùy chiều dài & tải
              </li>
              <li>
                <Text strong>Bảo vệ:</Text> Dùng CB chống giật, tiếp địa riêng (≤ 1Ω)
              </li>
              <li>
                <Text strong>Hệ thống dự phòng:</Text> Có hệ thống ATS/UPS nếu yêu cầu độ sẵn sàng
                cao
              </li>
            </ul>
          </Paragraph>
        ...
        <Card title='Xác định vị trí lắp đặt' style={{ marginBottom: '20px' }}>
          <Paragraph>
            <ul>
              <li>
                Cố định dàn lạnh tại vị trí trong phòng server theo đúng hướng gió (thổi sàn hoặc
                trần)
              </li>
              <li>Đặt thiết bị trên sàn cố định, đảm bảo độ cân bằng</li>
              <li>Kết nối nguồn điện 400V 3 pha, đảm bảo tiếp địa</li>
              <li>
                Gắn dàn nóng lên giá đỡ chắc chắn, có khe thoát nước ngưng và không đặt nghiêng quá
                mức khuyến nghị
              </li>
            </ul>
          </Paragraph>
      ...
      <div id='section-2.2.3' className='subsection'>
        <Title level={4} style={{ color: '#1890ff', marginBottom: '12px' }}>
          <CheckCircleOutlined style={{ marginRight: '8px' }} /> 2.2.3. Hướng dẫn vận hành và kiểm
          tra hàng ngày
        </Title>
        ...
        <Card title='2.2.3.1. Hướng dẫn vận hành' style={{ marginBottom: '20px' }}>
          ...
          <Paragraph>
            <ul>
              ...
              <li>
                Thiết bị khởi động theo thứ tự:
                <ul>
          ...
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
            Xác nhận các chỉ số hiển thị
          </Title>
          <Card size='small' style={{ marginBottom: '15px' }}>
            <Paragraph>
              <ul>
                <li>
                  <Text strong>Nhiệt độ phòng:</Text> 15 &lt; t &lt; 27 độ C
                </li>
                <li>
                  <Text strong>Cài đặt giới hạn sai số:</Text> &plusmn;0.5°C
                </li>
                <li>
                  <Text strong>Độ ẩm:</Text> 45% - 55% RH
                </li>
                <li>
                  <Text strong>Giới hạn độ ẩm cảnh báo:</Text> &plusmn;5%
                </li>
                <li>
                  <Text strong>Chế độ quạt:</Text> Auto hoặc Constant (tùy thiết kế)
                </li>
                <li>
                  <Text strong>Cài đặt chế độ vận hành:</Text> Làm mát / Sưởi / Tự động
                </li>
                <li>
                  <Text strong>Cảnh báo:</Text> Không có hoặc chỉ báo "NORMAL"
                </li>
              </ul>
            </Paragraph>
          </Card>
          ...
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
            Thiết lập kết nối giám sát
          </Title>
          <Paragraph>
            Vào menu Communication Settings:
            <ul>
              <li>
                <Text strong>Modbus Address:</Text> chọn theo sơ đồ BMS
              </li>
              <li>
                <Text strong>SNMP IP:</Text> gán IP tĩnh nếu giám sát qua LAN
              </li>
              <li>
                <Text strong>Trap Receiver:</Text> nhập địa chỉ máy chủ nhận cảnh báo
              </li>
            </ul>
          </Paragraph>
        ...
        <Card title='2.2.3.2. Kiểm tra hằng ngày' style={{ marginBottom: '20px' }}>
          ...
          <Paragraph>
            <ul>
              <li>
                <Text strong>Màn hình LCD:</Text> Không hiển thị cảnh báo, menu phản hồi nhanh
              </li>
              <li>
                <Text strong>Cửa gió thổi:</Text> Luồng gió đều, không rung hoặc kêu lạch cạch
              </li>
              <li>
                <Text strong>Âm thanh:</Text> Êm, không có tiếng nén lạ hoặc quạt xè xè
              </li>
              <li>
                <Text strong>Dàn nóng:</Text> Quạt hoạt động theo nhiệt độ, không lỗi HP/LP
              </li>
            </ul>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <ul>
              <li>
                <Text strong>System Info:</Text> Xem tổng quát trạng thái các thành phần
              </li>
              <li>
                <Text strong>Alarm History:</Text> Xem các cảnh báo gần nhất
              </li>
              <li>
                <Text strong>Sensor Status:</Text> Kiểm tra cảm biến nhiệt, ẩm
              </li>
              <li>
                <Text strong>Fan/Motor Status:</Text> Hiện trạng quạt, dòng điện, RPM
              </li>
            </ul>
          </Paragraph>
          ...
          <Alert
            ...
            description={
              <ul>
                <li key='setpoint'>
                  Không đổi setpoint nhiều hơn &plusmn;2°C hoặc 10% RH trong 1 lần
                </li>
                <li key='continuous'>
                  Duy trì vận hành liên tục – tránh bật/tắt liên tục trong ngày
                </li>
                <li key='filter'>Kiểm tra lọc gió định kỳ hàng tuần/tháng để tránh sụt gió</li>
                <li key='rotation'>
                  Luân phiên thiết bị (nếu nhiều tủ) theo mô hình N+1 để cân tải
                </li>
              </ul>
            }
            type='warning'
      ...
      <div id='section-2.2.4' className='subsection'>
        ...
        <Card title='Qua màn hình điều khiển tại thiết bị' style={{ marginBottom: '20px' }}>
          <Paragraph>
            <ul>
              <li>
                Vào menu: <Text code>Main Menu &gt; Alarms &gt; Active Alarm</Text>
              </li>
              <li>
                Hoặc xem nhật ký: <Text code>Main Menu &gt; Alarms &gt; Alarm History</Text>
              </li>
              <li>
                Lỗi thường hiển thị dạng: <Text code>AL#04: High Pressure</Text>,{' '}
                <Text code>AL#17: Fan Failure</Text>, ...
              </li>
            </ul>
          </Paragraph>
        </Card>
        ...
        <Card
          title='Bảng mã lỗi phổ biến và nguyên nhân theo tài liệu hãng'
          style={{ marginBottom: '20px' }}
        >
          <Table
            dataSource={[
        ...
        <Alert
          ...
          description={
            <ul>
              <li key='reset'>
                Một số lỗi không tự động reset sau khi hết điều kiện → yêu cầu kỹ thuật viên của đối
                tác xác nhận và bấm "Reset Alarm" trên màn hình
              </li>
              <li key='repeat'>
                Nếu lỗi tái xuất hiện &gt;3 lần trong ngày → cần lập biên bản sự cố, báo bộ phận kỹ
                thuật của đối tác/hãng
              </li>
              <li key='serious'>
                Với lỗi EEPROM, lỗi điều khiển nghiêm trọng: không nên tự sửa chữa → báo bộ phận kỹ
                thuật của đối tác/hãng
              </li>
            </ul>
          }
          ...
          <Table
            dataSource={[
              ...
              },
              {
                ...
                content:
                  'Kiểm tra tiếng ồn, độ rung, tốc độ RPM trên màn hình. Vệ sinh cánh quạt bằng khí nén hoặc khăn khô',
              ...
              },
              {
                ...
                content:
                  'Thổi khí nén nhẹ nhàng từ trong ra ngoài. Hoặc dùng dung dịch làm sạch coil không ăn mòn',
              ...
              },
              {
                ...
                content:
                  'Đo dòng điện hoạt động, áp suất hút – đẩy bằng đồng hồ gas (R410A). Kiểm tra rò rỉ dầu quanh thân máy',
              ...
              },
              {
                ...
                content:
                  'Vệ sinh khay bằng nước sạch, vệ sinh lưới lọc (nếu có). Dùng máy hút bụi nước hoặc khí thổi làm sạch đường ống xả',
              ...
              },
              {
                ...
                content:
                  'Kiểm tra độ nhạy nút bấm, màn hình hiển thị, phản hồi điều khiển. Thử login IP, SNMP trap, kết nối với BMS',
              ...
              },
              {
                ...
                content:
                  'Dùng khí nén hoặc nước xịt nhẹ từ trong ra. Kiểm tra hoạt động của quạt, độ rung, tốc độ quay',
              ...
              },
              {
                ...
                cycle: '6 tháng/lần',
                content:
                  'Kiểm tra điện trở heater bằng đồng hồ đo điện trở. Kiểm tra điện cực tạo ẩm có bị bám cặn hay không',
