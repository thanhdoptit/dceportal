  ...
  return (
    <div id='section-2.1' className='subsection'>
        ...
        <Card title='Thông tin cơ bản' style={{ marginBottom: '20px' }}>
          <Space direction='vertical' size='middle' style={{ width: '100%' }}>
            ...
            <div key='type'>
              ...
              <Text>
                Điều hòa làm mát không khí trực tiếp (Direct Expansion – DX), giải nhiệt bằng không
                khí (Air Cooled)
              </Text>
            </div>
            <div key='purpose'>
        ...
        <Card title='Thông số kỹ thuật chi tiết' style={{ marginBottom: '20px' }}>
          <Table
            dataSource={[
              ...
              {
                key: '3',
                spec: 'Tần số, điện áp đầu vào',
                value: '380V/400V/415V 3 pha, 50Hz hoặc 1 pha 220/230V',
              },
              { key: '4', spec: 'Môi chất làm lạnh', value: 'R410A' },
              { key: '5', spec: 'Tần suất làm việc liên tục', value: '24/24, 365 ngày/năm' },
              {
                key: '6',
                spec: 'Kích thước dàn lạnh',
                value: '1960mm (C) x 1720mm (R) x 865mm (Sâu)',
              },
              ...
              { key: '8', spec: 'Máy nén (compressor)', value: '2 Scroll (tốc độ cố định)' },
              {
                ...
                spec: 'Quạt dàn lạnh',
                value:
                  '2 quạt điều khiển điện tử EC centrifugal fan (hiệu suất cao, tiết kiệm năng lượng)',
              },
              ...
              { key: '12', spec: 'Bộ sưởi', value: 'Điện (electrical heater)' },
              {
                key: '13',
                spec: 'Van tiết lưu',
                value: 'Van tiết lưu điện tử (Electronic Expansion Valve – EEV)',
              },
              { key: '14', spec: 'Mức độ ồn', value: '54.6 dB(A) khi quạt chạy 100%' },
              {
                key: '15',
                spec: 'Màn hình hiển thị',
                value: 'Semi-graphic, có thể tải/cập nhật firmware và giám sát hoạt động',
              },
              {
                key: '16',
                spec: 'Tủ điện/microprocessor',
                value: 'Theo dõi và tối ưu các điều kiện vận hành, hiển thị cảnh báo khi có lỗi',
              },
      ...
      <div id='section-2.1.2' className='subsection'>
        ...
        <Card title='Xác định vị trí lắp đặt' style={{ marginBottom: '20px' }}>
          <Paragraph>
            <ul>
              <li>
                Thiết bị dàn lạnh cần được đặt trong nhà (indoor) với kích thước 1960mm x 1720mm x
                865mm
              </li>
              <li>
                Dàn nóng (outdoor unit) đặt ngoài trời, có khả năng chịu nhiệt độ tới 45°C, kích
                thước 2277mm x 350mm x 700mm
              </li>
              <li>
                Đảm bảo thông thoáng cho gió vào/ra (không cản trở luồng không khí từ quạt EC)
              </li>
              <li>
                Không lắp quá sát tường hoặc thiết bị khác, đảm bảo bảo trì mặt trước (full frontal
                accessibility)
              </li>
            </ul>
          </Paragraph>
      ...
      <div id='section-2.1.3' className='subsection'>
        <Title level={4}>
          <ExclamationCircleOutlined style={{ marginRight: '8px' }} /> 2.1.3. Hướng dẫn vận hành và
          kiểm tra hàng ngày
        </Title>

        <Card
          title='2.1.3.1. Vận hành cơ bản'
          className='subsection'
          style={{ marginBottom: '20px' }}
        >
          <Paragraph>
            Máy điều hòa chính xác TDAV1321A hoạt động theo chế độ tự động, điều khiển bằng vi xử lý
            (microprocessor controller) và giao diện màn hình semi-graphic. Người dùng chỉ cần vận
            hành theo các bước:
          </Paragraph>
                ...
                description: (
                  <div>
                    ...
                    <ul style={{ marginLeft: '20px', marginBottom: '8px' }}>
                      ...
                      <li>
                        Quan sát màn hình: trạng thái khởi động, cảnh báo nếu có, thông số cài đặt
                      </li>
                    </ul>
                  </div>
                ),
                ...
                description: (
                  <div>
                    ...
                    <ul style={{ marginLeft: '20px', marginBottom: '8px' }}>
                      ...
                      <li>
                        Auto (tự động chuyển đổi theo điều kiện) - Hệ thống tự động chọn chế độ phù
                        hợp
                      </li>
              ...
              },
              {
                ...
                description: (
                  <div>
                    ...
                    <ul style={{ marginLeft: '20px', marginBottom: '8px' }}>
                      <li>
                        <Text strong>Nhiệt độ:</Text> 15°C {'<'} t {'<'} 27°C - Phạm vi nhiệt độ
                        hoạt động an toàn
                      </li>
                      <li>
                        <Text strong>Giới hạn nhiệt độ cảnh báo:</Text> ±0.5°C - Ngưỡng cảnh báo khi
                        nhiệt độ vượt quá
                      </li>
                      <li>
                        <Text strong>Độ ẩm:</Text> 45% - 55% RH - Phạm vi độ ẩm tối ưu cho thiết bị
                        CNTT
                      </li>
                      <li>
                        <Text strong>Giới hạn độ ẩm cảnh báo:</Text> ±3% - Ngưỡng cảnh báo khi độ ẩm
                        vượt quá
                      </li>
                      <li>
                        <Text strong>Cài đặt chế độ vận hành:</Text> Làm mát / Sưởi / Tự động - Lựa
                        chọn chế độ hoạt động chính
                      </li>
                      <li>
                        <Text strong>Bật/tắt chức năng:</Text> Phun ẩm, bộ sưởi hoặc quạt theo thời
                        gian - Điều khiển các chức năng phụ trợ
                      </li>
                      <li>
                        <Text strong>Kiểm tra chế độ dự phòng N+1:</Text> Đảm bảo chỉ 1 thiết bị ở
                        chế độ standby - Đảm bảo hệ thống dự phòng hoạt động đúng
                      </li>
                    </ul>
                  </div>
                ),
              },
              {
                ...
                description: (
                  <div>
                    ...
                    <ul style={{ marginLeft: '20px', marginBottom: '8px' }}>
                      <li>
                        <Text strong>SNMP:</Text> Cấu hình IP thiết bị, subnet mask, gateway - Thiết
                        lập kết nối mạng cho giám sát từ xa
                      </li>
                      <li>
                        <Text strong>Modbus:</Text> Đặt địa chỉ thiết bị, tốc độ baud rate, parity,
                        stop bit - Cấu hình giao thức truyền thông công nghiệp
                      </li>
                      <li>
                        Cài đặt tích hợp với NetBotz - Kết nối với hệ thống giám sát môi trường
                      </li>
                    </ul>
                  </div>
                ),
        ...
        <Card title='2.1.3.2. Kiểm tra hàng ngày' style={{ marginBottom: '20px' }}>
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
            Kiểm tra qua màn hình điều khiển
          </Title>
          <div style={{ textAlign: 'center', marginBottom: '20px' }}>
            <img
          ...
          <ul>
            <li>
              <Text strong>Xem trạng thái thiết bị:</Text> "RUNNING", "STANDBY", "ALARM"
            </li>
            <li>
              <Text strong>Kiểm tra thông số:</Text>
              <ul>
          ...
          <Paragraph>
            <Text strong>Cảnh báo thường gặp:</Text>
          </Paragraph>
          <ul>
          ...
          <Paragraph>
            <Text strong>Lưu ý:</Text> Các cảnh báo được lưu và có thể xem lại lịch sử trong menu
            ALARM LOG
          </Paragraph>
        </Card>
      </div>
      ...
      <div id='section-2.1.4' className='subsection'>
        <Title level={4}>
          <ExclamationCircleOutlined style={{ marginRight: '8px' }} /> 2.1.4. Hướng dẫn xác định
          nguyên nhân lỗi
        </Title>

        <Card title='Các phương pháp xác định lỗi' style={{ marginBottom: '20px' }}>
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
            Màn hình điều khiển trung tâm (trên dàn lạnh)
          </Title>
          <ul>
          ...
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
            Giao diện phần mềm giám sát từ xa
          </Title>
          <ul>
          ...
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
            Các thiết bị giám sát môi trường đi kèm (NetBotz...)
          </Title>
          <ul>
            <li>
              Có thể phát hiện lỗi từ môi trường: độ ẩm quá cao, nhiệt độ tăng đột ngột, rò rỉ
              nước...
            </li>
          </ul>

          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
            Xem mã lỗi và mô tả lỗi trên màn hình
          </Title>
          <ul>
          ...
          <Title level={5} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
            Kiểm tra thông số hoạt động thực tế
          </Title>
          <ul>
          ...
          <ul>
            <li>
              <Text strong>Nhóm nguồn:</Text> máy không khởi động, mất điện
            </li>
            <li>
              <Text strong>Nhóm lưu lượng gió:</Text> yếu lạnh, lỗi quạt, tắc lọc
            </li>
            <li>
              <Text strong>Nhóm môi chất lạnh:</Text> thiếu gas, nghẹt ống, hỏng van
            </li>
            <li>
              <Text strong>Nhóm điều khiển:</Text> cảm biến sai, mất tín hiệu, cấu hình sai
            </li>
          </ul>
        ...
        <Card
          title='Các lỗi thường gặp và cách xác định nguyên nhân'
          style={{ marginBottom: '20px' }}
        >
          <Table
            dataSource={[
        ...
        <Card title='Mục tiêu của bảo trì định kỳ' style={{ marginBottom: '20px' }}>
          <Paragraph>
            <ul>
              ...
              <li>
                Tối ưu hóa tuổi thọ các linh kiện: máy nén, quạt EC, cảm biến, lọc khí, bộ sưởi
              </li>
            ...
            dataSource={[
              {
                ...
                cycle: 'Hàng tháng',
                content:
                  'Tháo bộ lọc ra vệ sinh (bụi bám). Thay mới nếu biến dạng, thủng hoặc giảm lưu lượng',
              ...
              },
              {
                ...
                content:
                  'Đo dòng vận hành & khởi động. Kiểm tra độ rung, ống đồng, tiếng ồn bất thường',
              ...
              },
              {
                ...
                cycle: '6 tháng – 12 tháng',
                content:
                  'Kiểm tra vòi phun, bơm nước. Tẩy cặn canxi nếu dùng nước cứng. Kiểm tra điện trở bốc hơi',
              ...
              },
              {
                ...
                content:
                  'Vệ sinh khay. Kiểm tra ống xả không nghẹt. Đảm bảo không tràn nước hoặc rò rỉ',
              ...
              },
              {
                ...
                cycle: '6 tháng – 12 tháng',
                content:
                  'Kiểm tra màn hình, nút bấm. Cập nhật phần mềm nếu Schneider cung cấp. Kiểm tra giao tiếp Modbus/SNMP',
              ...
              },
              {
                ...
                cycle: 'Hàng tuần',
                content:
                  'Xem lại log alarm. Phân tích và khắc phục cảnh báo. Đánh giá hiệu suất thiết bị',
        ...
        <Alert
          ...
          description={
            <ul>
              ...
              <li key='backup'>
                Có thể vận hành dự phòng N+1, tạm dừng từng thiết bị để bảo trì mà không ảnh hưởng
                hệ thống
              </li>
              <li key='record'>Ghi chép phiếu bảo trì, ảnh chụp log lỗi, kết quả đo đạc</li>
              <li key='material'>
                Sử dụng vật tư tiêu chuẩn: lọc khí EU4, R410A đúng áp suất, quạt EC chính hãng
              </li>
            </ul>
          }
          type='warning'
