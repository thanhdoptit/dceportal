        ...
        {items.map(item => (
          <Col xs={24} sm={12} key={item.key}>
            <Card
              ...
              onClick={() =>
                handleCardClick(item.route, title === 'TTDL Hòa Lạc' ? 'hoalac' : 'vancanh')
              }
            >
              {/* Content */}
      ...
      >
        ...
        <div
          style={{
            ...
            height: '270px',
            background:
              'linear-gradient(135deg, #1890ff 0%, #096dd9 30%, #0050b3 70%, #003a8c 100%)',
            borderRadius: '24px',
        ...
        >
          ...
          <div
            style={{
              ...
              height: '200%',
              background:
                'radial-gradient(circle at 30% 20%, rgba(255,255,255,0.15) 0%, transparent 40%), radial-gradient(circle at 70% 80%, rgba(255,255,255,0.1) 0%, transparent 40%), radial-gradient(circle at 90% 10%, rgba(255,255,255,0.08) 0%, transparent 30%)',
            ...
            >
              ...
              <div
                style={{
                  ...
                  bottom: '-8px',
                  background:
                    'radial-gradient(circle, rgba(24, 144, 255, 0.3) 0%, transparent 70%)',
                  borderRadius: '26px',
                  filter: 'blur(6px)',
                  zIndex: -1,
                }}
