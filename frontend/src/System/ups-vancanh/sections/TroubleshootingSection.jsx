...
const TroubleshootingSection = () => {
  ...
  return (
    <div className='content-section'>
      ...
      <Paragraph>
        Hệ thống UPS Galaxy VL được thiết kế với độ tin cậy cao, tuy nhiên trong quá trình vận hành
        vẫn có thể gặp phải một số sự cố. Phần này cung cấp hướng dẫn chi tiết về cách nhận diện,
        phân tích và khắc phục các sự cố thường gặp.
      </Paragraph>
      ...
      <div id='section-6-1' className='subsection'>
        <Title level={3}>6.1. Các sự cố thường gặp</Title>
      ...
      <div id='section-6-2' className='subsection'>
        <Title level={3}>6.2. Quy trình khắc phục</Title>

        {/* 6.2.1 - Phân tích sự cố */}
        <div id='6.2.1' className='subsection'>
          <Title level={4}>6.2.1. Phân tích sự cố</Title>
        ...
        <div id='6.2.2' className='subsection'>
          <Title level={4}>6.2.2. Các bước khắc phục</Title>
        ...
        <div id='6.2.3' className='subsection'>
          <Title level={4}>6.2.3. Kiểm tra sau khắc phục</Title>
