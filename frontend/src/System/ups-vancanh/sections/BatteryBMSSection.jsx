...
const BatteryBMSSection = () => {
  ...
  return (
    <div className='content-section'>
      ...
      <Paragraph>
        Hệ thống ắc quy và BMS (Battery Management System) là thành phần quan trọng của hệ thống
        UPS, đảm bảo cung cấp năng lượng dự phòng khi có sự cố nguồn điện lưới.
      </Paragraph>

      {/* 3.1 - Hệ thống ắc quy */}
      <div id='section-3-1' className='subsection'>
        <Title level={3}>3.1. Hệ thống ắc quy</Title>
        <Card title='Thông tin tổng quan hệ thống ắc quy' style={{ marginBottom: '20px' }}>
          ...
          <div id='3.1.1' className='subsection'>
            <Title level={4}>3.1.1. Loại ắc quy sử dụng</Title>
            <Row gutter={[16, 16]}>
              <Col xs={24} lg={12}>
                <Card size='small' title='Đặc điểm kỹ thuật'>
                  <Paragraph>
                    Hệ thống UPS Galaxy VL sử dụng ắc quy VRLA (Valve Regulated Lead Acid) với các
                    đặc điểm:
                  </Paragraph>
                  <ul>
                    <li>
                      <Text strong>Loại:</Text> VRLA Sealed Lead Acid
                    </li>
                    <li>
                      <Text strong>Điện áp:</Text> 12V per cell
                    </li>
                    <li>
                      <Text strong>Dung lượng:</Text> 100Ah - 200Ah
                    </li>
                    <li>
                      <Text strong>Tuổi thọ:</Text> 5-7 năm
                    </li>
                    <li>
                      <Text strong>Bảo trì:</Text> Không cần bảo trì
                    </li>
                  </ul>
                </Card>
              </Col>
          ...
          <div id='3.1.2' className='subsection'>
            <Title level={4}>3.1.2. Tính toán dung lượng</Title>
            <Row gutter={[16, 16]}>
              <Col xs={24} lg={12}>
          ...
          <div id='3.1.3' className='subsection'>
            <Title level={4}>3.1.3. Tuổi thọ và thay thế</Title>
            <Row gutter={[16, 16]}>
              <Col xs={24} sm={12}>
                <Card size='small' title='Yếu tố ảnh hưởng tuổi thọ'>
                  <ul>
                    <li>
                      <Text strong>Nhiệt độ:</Text> Nhiệt độ cao làm giảm tuổi thọ
                    </li>
                    <li>
                      <Text strong>Độ sâu xả:</Text> Xả sâu làm giảm tuổi thọ
                    </li>
                    <li>
                      <Text strong>Chu kỳ sạc/xả:</Text> Số lần sạc/xả ảnh hưởng trực tiếp
                    </li>
                    <li>
                      <Text strong>Chất lượng sạc:</Text> Sạc không đúng làm hỏng ắc quy
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <Card title='Thông tin tổng quan BMS' style={{ marginBottom: '20px' }}>
              ...
              <Row gutter={[16, 16]}>
                <Col xs={24} lg={12}>
                  <Card size='small' title='Hardware Specifications'>
                    <ul>
                      <li>
                        <Text strong>CPU:</Text> Quad Core 1.2GHz Broadcom BCM2837 64bit
                      </li>
                      <li>
                        <Text strong>OS:</Text> Windows IoT
                      </li>
                      <li>
                        <Text strong>Display:</Text> 7" 1024x600 Graphic Touch Screen
                      </li>
                      <li>
                        <Text strong>Communications:</Text> WiFi, 3G, Ethernet, RS485
                      </li>
                      <li>
                        <Text strong>Capacity:</Text> Up to 4x256 kits of BMK/SMK
                      </li>
                      <li>
                        <Text strong>Max Cells:</Text> Up to 1020 cells monitoring
                      </li>
                    </ul>
                  </Card>
                </Col>
                <Col xs={24} lg={12}>
                  <Card size='small' title='Supported Battery Types'>
                    <ul>
                      <li>
                        <Text strong>VRLA:</Text> Valve Regulated Lead Acid
                      </li>
                      <li>
                        <Text strong>Ni-Cd:</Text> Nickel-Cadmium batteries
                      </li>
                      <li>
                        <Text strong>Lithium:</Text> Li-Ion battery systems
                      </li>
                      <li>
                        <Text strong>Salt Water:</Text> Alternative chemistry
                      </li>
                      <li>
                        <Text strong>Installation:</Text> Non-intrusive, online compatible
                      </li>
                      <li>
                        <Text strong>Data Storage:</Text> Web server with internet connectivity
                      </li>
                    </ul>
                  </Card>
                </Col>
          ...
          */}
          ...
          <div id='3.2.2' className='subsection'>
            <Title level={4}>3.2.2. Các thông số giám sát BMS272</Title>
              ...
              <Row gutter={[16, 16]}>
                <Col xs={24} lg={12}>
                  <Card size='small' title='Thông số điện'>
                    <ul>
                      <li>
                        <Text strong>String Voltages:</Text> Điện áp string real-time
                      </li>
                      <li>
                        <Text strong>String Currents:</Text> Dòng điện string
                      </li>
                      <li>
                        <Text strong>Cell Voltages:</Text> Điện áp từng cell
                      </li>
                      <li>
                        <Text strong>Internal Voltages:</Text> Điện áp nội bộ
                      </li>
                      <li>
                        <Text strong>Internal Resistance:</Text> Trở kháng nội
                      </li>
                      <li>
                        <Text strong>Connection Resistance:</Text> Trở kháng kết nối
                      </li>
                    </ul>
                  </Card>
                </Col>
                <Col xs={24} lg={12}>
                  <Card size='small' title='Thông số môi trường'>
                    <ul>
                      <li>
                        <Text strong>Temperature:</Text> Nhiệt độ từng cell và môi trường
                      </li>
                      <li>
                        <Text strong>Liquid Level:</Text> Mức chất điện phân (nếu có)
                      </li>
                      <li>
                        <Text strong>Battery Health:</Text> Đánh giá sức khỏe ắc quy
                      </li>
                      <li>
                        <Text strong>Life Expectancy:</Text> Dự báo tuổi thọ
                      </li>
                      <li>
                        <Text strong>Charge/Discharge Status:</Text> Trạng thái sạc/xả
                      </li>
                      <li>
                        <Text strong>Trend Analysis:</Text> Phân tích xu hướng
                      </li>
                    </ul>
                  </Card>
                </Col>
          ...
          */}
          ...
          <div id='3.2.3' className='subsection'>
            <Title level={4}>3.2.3. Cảnh báo và báo cáo</Title>
            <Row gutter={[16, 16]}>
              <Col xs={24} lg={12}>
              ...
              <Col xs={24} lg={12}>
                <Card size='small' title='Báo cáo định kỳ'>
                  <ul>
                    <li>
                      <Text strong>Báo cáo hàng ngày:</Text> Thống kê hoạt động
                    </li>
                    <li>
                      <Text strong>Báo cáo hàng tuần:</Text> Phân tích hiệu suất
                    </li>
                    <li>
                      <Text strong>Báo cáo hàng tháng:</Text> Đánh giá sức khỏe ắc quy
                    </li>
                    <li>
                      <Text strong>Báo cáo hàng năm:</Text> Kế hoạch thay thế
                    </li>
                  </ul>
                </Card>
              </Col>
            ...
            <Row gutter={[16, 16]}>
              ...
              <Col xs={24} lg={12}>
                <Card size='small' title='Giám sát liên tục'>
                  <Paragraph>BMS hoạt động 24/7 để giám sát:</Paragraph>
                  <ul>
