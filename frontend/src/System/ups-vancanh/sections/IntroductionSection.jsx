...
const IntroductionSection = () => {
  ...
  const systemOverview = {
    ...
    description:
      'Hệ thống UPS (Uninterruptible Power Supply) Galaxy VL và ắc quy BMS tại Trung tâm Dữ liệu Vân Canh được thiết kế để đảm bảo cung cấp nguồn điện liên tục và ổn định cho các thiết bị quan trọng của trung tâm dữ liệu.',
  ...
  const bmsSystem = {
    ...
    description:
      'Hệ thống giám sát ắc quy thông minh với khả năng giám sát lên đến 1020 cell và tích hợp nhiều giao thức truyền thông.',
    components: [
      {
  ...
  const systemArchitecture = {
    ...
    description:
      'Hệ thống được thiết kế theo kiến trúc module hóa, hỗ trợ cả cấu hình đơn lẻ và song song với khả năng mở rộng linh hoạt.',
    configurations: [
      {
        type: 'Single System',
  ...
  return (
    <div className='content-section'>
      ...
      <Paragraph>
        Hệ thống UPS (Uninterruptible Power Supply) Galaxy VL và ắc quy BMS tại Trung tâm Dữ liệu
        Vân Canh được thiết kế để đảm bảo cung cấp nguồn điện liên tục và ổn định cho các thiết bị
        quan trọng.
      </Paragraph>

      {/* 1.1 - Thông số kỹ thuật hệ thống UPS */}
      <div id='section-1-1' className='subsection'>
        <Title level={3}>1.1. Thông số kỹ thuật hệ thống UPS</Title>
            ...
            {technicalSpecs.map((spec, index) => (
              <Col xs={24} lg={12} key={index}>
                <Card
                  ...
                  style={{ height: '100%' }}
                  styles={{
                    header: { backgroundColor: '#f0f9ff', borderBottom: '1px solid #d1ecf1' },
                  }}
                >
      ...
      <div id='section-1-2' className='subsection'>
        <Title level={3}>1.2. Cấu trúc và nguyên lý hoạt động</Title>
      ...
      <div id='section-1-3' className='subsection'>
        <Title level={3}>1.3. Các chế độ vận hành chính</Title>
      ...
      <div id='section-1-4' className='subsection'>
        <Title level={3}>1.4. Hệ thống giám sát BMS</Title>
