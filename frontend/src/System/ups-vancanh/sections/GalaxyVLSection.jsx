...
const GalaxyVLSection = () => {
  ...
  return (
    <div className='content-section'>
      ...
      <Paragraph>
        Hệ thống UPS Galaxy VL là giải pháp UPS 3 pha công suất cao của Schneider Electric, được
        thiết kế đặc biệt cho các ứng dụng trung tâm dữ liệu yêu cầu độ tin cậy cao.
      </Paragraph>

      {/* 2.1 - Thông tin chung Galaxy VL */}
      <div id='section-2-1' className='subsection'>
        <Title level={3}>2.1. Thông tin chung Galaxy VL</Title>

        {/* 2.1.1 - Đặc điểm kỹ thuật */}
        <div id='2.1.1' className='subsection'>
          <Title level={4}>2.1.1. Đặc điểm kỹ thuật</Title>
          <Card size='small' style={{ marginBottom: '16px' }} title='Đặc điểm kỹ thuật'>
            <ul>
              <li>
                <Text strong>Công nghệ:</Text> Double-conversion online
              </li>
              <li>
                <Text strong>Topology:</Text> IGBT-based inverter
              </li>
              <li>
                <Text strong>PFC:</Text> Unity power factor correction
              </li>
              <li>
                <Text strong>Hiệu suất:</Text> Lên đến 97.2% ở chế độ Double-conversion
              </li>
              <li>
                <Text strong>THD:</Text> {'<'}3% (linear load), {'<'}8% (non-linear load)
              </li>
              <li>
                <Text strong>Overload:</Text> 125% trong 10 phút, 150% trong 1 phút
              </li>
            </ul>
          </Card>
        </div>
        ...
        <div id='2.1.2' className='subsection'>
          <Title level={4}>2.1.2. Thông số điện</Title>
          <Table
        ...
        <div id='2.1.3' className='subsection'>
          <Title level={4}>2.1.3. Cấu hình hệ thống và hiệu suất</Title>
          ...
          >
            ...
            />
            <Table.Column
              title='eConversion Mode'
              dataIndex='eConversion'
              key='eConversion'
          ...
          {/* IMAGE IMPORT NOTES */}
          === IMAGES NEEDED FOR SECTION 2.1.3 === 1. Galaxy VL single system diagram 2. Galaxy VL
          parallel system topology 3. Efficiency performance charts 4. System configuration diagrams
          from Galaxy VL brochure Example usage:
          <ImageGallery
            images={[
              {
                src: '/ups-vancanh/ups/galaxy-vl-brochure-page01-001.png',
                alt: 'Galaxy VL Single System',
                caption: 'Cấu hình hệ thống đơn lẻ',
              },
              {
                src: '/images/ups/galaxy-vl-parallel-system.jpg',
                alt: 'Galaxy VL Parallel System',
                caption: 'Cấu hình hệ thống song song',
              },
            ]}
            columns={2}
            imageWidth={300}
      ...
      <div id='section-2-2' className='subsection'>
        <Title level={3}>2.2. Hướng dẫn lắp đặt</Title>

        {/* 2.2.1 - Yêu cầu môi trường */}
        <div id='2.2.1' className='subsection'>
          <Title level={4}>2.2.1. Yêu cầu môi trường</Title>
          <Card size='small' style={{ marginBottom: '16px' }}>
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <div>
        ...
        <div id='2.2.2' className='subsection'>
          <Title level={4}>2.2.2. Quy trình lắp đặt</Title>
          <Card size='small' style={{ marginBottom: '16px' }}>
            <Steps
              ...
              items={[
                {
                  title: 'Chuẩn bị vị trí lắp đặt',
                  description: 'Kiểm tra không gian, nền móng, thông gió',
                },
                {
                  title: 'Vận chuyển và định vị',
                  description: 'Di chuyển thiết bị đến vị trí cuối cùng',
                },
                {
                  title: 'Kết nối cơ khí',
                  description: 'Lắp đặt thanh đồng, cable tray, grounding',
                },
                { title: 'Kết nối điện', description: 'Đấu nối input, output, bypass, battery' },
                {
                  title: 'Kiểm tra và commissioning',
                  description: 'Test chức năng, calibration, documentation',
                },
              ]}
            />
          </Card>
        ...
        <div id='2.2.3' className='subsection'>
          <Title level={4}>2.2.3. Kết nối điện và mạng</Title>
          <Card size='small' style={{ marginBottom: '16px' }}>
            <Row gutter={[16, 16]}>
              <Col xs={24} lg={12}>
      ...
      <div id='section-2-3' className='subsection'>
        <Title level={3}>2.3. Hướng dẫn vận hành</Title>

        {/* 2.3.1 - Khởi động hệ thống */}
        <div id='2.3.1' className='subsection'>
          <Title level={4}>2.3.1. Khởi động hệ thống</Title>
          <Card size='small' style={{ marginBottom: '16px' }}>
            <Steps
              ...
              items={[
                {
                  title: 'Kiểm tra trước khởi động',
                  description: 'Voltage, connections, battery status',
                },
                {
                  title: 'Khởi động rectifier',
                  description: 'Turn ON input breaker, wait for DC bus charge',
                },
                {
                  title: 'Khởi động inverter',
                  description: 'Press START button, verify output voltage',
                },
                { title: 'Chuyển load', description: 'Transfer load từ bypass sang inverter' },
                {
                  title: 'Kiểm tra hoạt động',
                  description: 'Verify all parameters, alarms, measurements',
                },
              ]}
            />
          </Card>
        ...
        <div id='2.3.2' className='subsection'>
          <Title level={4}>2.3.2. Chế độ vận hành</Title>
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} md={12} lg={6}>
              <Card size='small' style={{ textAlign: 'center', height: '100%' }}>
                ...
                <Text style={{ fontSize: '12px' }}>Vận hành bằng battery khi mất điện lưới</Text>
              </Card>
            </Col>
            <Col xs={24} md={12} lg={6}>
              <Card size='small' style={{ textAlign: 'center', height: '100%' }}>
                ...
                <Text style={{ fontSize: '12px' }}>Load được cung cấp trực tiếp từ lưới</Text>
              </Card>
            </Col>
            <Col xs={24} md={12} lg={6}>
              <Card size='small' style={{ textAlign: 'center', height: '100%' }}>
                ...
                <Text style={{ fontSize: '12px' }}>Chế độ bảo trì, UPS isolated</Text>
              </Card>
            </Col>
          </Row>
        </div>
        ...
        <div id='2.3.3' className='subsection'>
          <Title level={4}>2.3.3. Giám sát thông số</Title>
          <Alert
      ...
      <div id='section-2-4' className='subsection'>
        <Title level={3}>2.4. Bảo trì và bảo dưỡng</Title>

        {/* 2.4.1 - Bảo trì định kỳ */}
        <div id='2.4.1' className='subsection'>
          <Title level={4}>2.4.1. Bảo trì định kỳ</Title>
          <Card size='small' style={{ marginBottom: '16px' }}>
            <Steps
              ...
              items={[
                {
                  title: 'Hàng tháng',
                  description: 'Visual inspection, measurement log, battery test',
                },
                {
                  title: 'Hàng quý',
                  description: 'Detailed inspection, filter cleaning, calibration check',
                },
                {
                  title: 'Hàng năm',
                  description: 'Complete overhaul, battery replacement assessment',
                },
        ...
        <div id='2.4.2' className='subsection'>
          <Title level={4}>2.4.2. Thay thế ắc quy</Title>
          <Alert
        ...
        <div id='2.4.3' className='subsection'>
          <Title level={4}>2.4.3. Xử lý sự cố</Title>
          <Row gutter={[16, 16]}>
            <Col xs={24} lg={12}>
