...
const MonitoringSection = () => {
  ...
  const userInterfaceInfo = {
    ...
    description: 'Hệ thống UPS Galaxy VL được trang bị màn hình cảm ứng thông minh với các tính năng điều khiển và giám sát tiên tiến.',
    mainFeatures: [
      {
  ...
  const scadaIntegration = {
    ...
    description: 'UPS Galaxy VL được thiết kế để tích hợp dễ dàng với các hệ thống SCADA và DCS hiện có.',
    features: [
      {
  ...
  const systemSettings = [
    {
      ...
      settings: [
        { name: 'Điện áp đầu ra', description: 'Cấu hình điện áp đầu ra (380V, 400V, 415V, 440V, 480V)' },
        ...
        { name: 'Chế độ hoạt động', description: 'Cấu hình chế độ hoạt động (Normal, Eco, Line-interactive)' }
      ]
    },
    {
  ...
  return (
    <div className="content-section">
      ...
      <Paragraph>
        Hệ thống UPS Galaxy VL được trang bị các tính năng giám sát và điều khiển tiên tiến, 
