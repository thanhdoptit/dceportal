...
const OperationSection = () => {
  ...
  const systemInfo = {
    ...
    description:
      'Hướng dẫn vận hành thực tế cho hệ thống UPS Galaxy VL 500kVA đang hoạt động tại Trung tâm Dữ liệu Vân Canh. Tài liệu này cung cấp các quy trình vận hành cụ thể và chi tiết cho hệ thống thực tế.',
  ...
  const controlInterfaceInfo = {
    ...
    description:
      'Hệ thống UPS Galaxy VL được trang bị màn hình cảm ứng thông minh với các nút điều khiển chính:',
    features: [
      {
        name: 'Nút Home (A)',
  ...
  const operationModes = [
    ...
    },
    {
      ...
      description:
        'Nếu nguồn điện lưới không thành công, UPS sẽ chuyển sang hoạt động bằng ắc quy và hỗ trợ tải bằng nguồn điện ổn định từ ắc quy',
      icon: '🔋',
      features: [
    ...
    },
    {
      ...
      description:
        'UPS có thể được chuyển sang hoạt động bypass tĩnh được yêu cầu sau một lệnh từ màn hình',
      icon: '⚡',
      features: [
    ...
    },
    {
      ...
      description:
        'UPS hoạt động ở chế độ bypass cưỡng bức theo lệnh của UPS hoặc do người dùng đã nhấn nút TẮT biến tần',
      icon: '🔧',
      features: [
    ...
    },
    {
      ...
      description:
        'Khi đóng ngắt attomat Maintenance Bypass, UPS sẽ chuyển sang hoạt động ở chế độ Maintenance Bypass',
      icon: '🔌',
      features: [
  ...
  const maintenanceProcedures = [
    {
      ...
      description:
        'Đối với tất cả các quy trình mở cửa trước ngoài cùng của thiết bị, Schneider Electric khuyến nghị tối thiểu các thiết bị bảo vệ cá nhân (PPE) sau đây:',
      isPPE: true,
      steps: ppeRequirements.map(item => item.item),
      warning:
        'NGUY CƠ THƯƠNG TÍCH CÁ NHÂN - Luôn thực hiện đánh giá rủi ro trước khi vận hành hoặc bảo trì thiết bị này. Sử dụng thiết bị bảo vệ cá nhân phù hợp.',
    },
    {
    ...
    },
    {
      ...
      dangerWarning:
        'NGUY CƠ SỐC ĐIỆN, NỔ HOẶC CHÁY HỒ QUANG - Kiểm tra xem UPS có nhãn Live Swap không. Nếu không có nhãn Live Swap trên UPS thì phải chuyển UPS sang chế độ bảo trì bỏ qua hoặc tắt UPS trước khi có thể lắp hoặc tháo mô-đun nguồn.',
      cautionWarning:
        'NGUY CƠ THIẾT BỊ HƯ HỎNG - Bảo quản các mô-đun nguồn ở nhiệt độ môi trường từ -15 đến 40 °C (5 đến 104 °F), độ ẩm 10-80%.',
      heavyWarning:
        'TẢI NẶNG - Các mô-đun nguồn rất nặng (38 kg (83,77 lbs)) và cần hai người để nâng.',
      overloadWarning:
        'NGUY CƠ QUÁ TẢI LẮP ĐẶT - Kiểm tra và xác minh rằng lắp đặt có kích thước chính xác để tăng định mức công suất trước khi lắp thêm mô-đun nguồn vào UPS.',
      dropLoadWarning:
        'NGUY CƠ RƠI TẢI - Kiểm tra và xác minh rằng các mô-đun nguồn còn lại có thể chịu được tải trước khi tháo mô-đun nguồn ra khỏi UPS.',
      steps: [
  ...
  return (
    <div className='content-section'>
      ...
      <div id='section-5-1' className='subsection'>
        <Title level={3}>5.1. Vận hành UPS Galaxy 500KVA Vân Canh</Title>

        {/* 5.1.1 Hướng dẫn an toàn */}
        <div id='5.1.1' className='subsection'>
          <Title level={4}>5.1.1. Hướng dẫn an toàn</Title>
          <Card title='Hướng dẫn an toàn' style={{ marginBottom: '16px' }}>
            ...
            <Title level={4}>Biểu tượng cảnh báo an toàn</Title>
            <Paragraph>
              Các biểu tượng cảnh báo an toàn xuất hiện xuyên suốt tài liệu để cảnh báo về các nguy
              cơ tiềm ẩn:
            </Paragraph>
            <Row gutter={[16, 16]}>
        ...
        <div id='5.1.2' className='subsection'>
          <Title level={4}>5.1.2. Tổng quan hệ thống</Title>
          ...
          <div id='5.1.2' className='subsection'>
            <Title level={4}>5.1.2. Giao diện điều khiển</Title>
          ...
          <Title level={4}>Các chế độ hoạt động của hệ thống</Title>
        ...
        <div id='5.1.3' className='subsection'>
          <Title level={4}>5.1.3. Quy trình vận hành</Title>

          {/* Quy trình khởi động hệ thống đơn lẻ */}
          <Title level={4}>Quy trình khởi động hệ thống đơn lẻ</Title>
          ...
          <Title level={4}>Quy trình tắt máy an toàn</Title>
          ...
          <Title level={4}>Các thao tác chuyển đổi chế độ</Title>
          <Card
            title='Chuyển UPS từ chế độ bình thường sang chế độ static bypass'
            style={{ marginBottom: '16px' }}
          >
          ...
          <Card
            title='Chuyển UPS từ chế độ static bypass sang chế độ hoạt động bình thường'
            style={{ marginBottom: '16px' }}
          >
            <Steps direction='vertical' size='small'>
              <Steps.Step
          ...
          {/* Điều khiển Inverter */}
          <Title level={4}>Điều khiển Inverter</Title>
          ...
          <Title level={4}>Chuyển UPS từ chế độ bình thường sang Maintenance Bypass</Title>
          <Card title='Chuyển sang chế độ Maintenance Bypass' style={{ marginBottom: '16px' }}>
            ...
            <Steps direction='vertical' size='small'>
              <Steps.Step
                title='Bước 1-5: Chuyển bypass'
                description='Control > Operation mode > Transfer to bypass operation > OK'
              />
          ...
          <Card
            title='Chuyển UPS từ chế độ Maintenance Bypass sang hoạt động bình thường'
            style={{ marginBottom: '16px' }}
          >
            <Steps direction='vertical' size='small'>
              <Steps.Step
              ...
              <Steps.Step
                title='Bước 7: Truy cập Control'
                description='Từ màn hình chính, chọn Control'
              />
              <Steps.Step
                title='Bước 8: Chuyển về normal'
                description='Chọn Transfer to normal operation'
              />
          ...
          <Card title='Bật UPS từ chế độ Maintenance Bypass' style={{ marginBottom: '16px' }}>
            <Steps direction='vertical' size='small'>
              ...
              <Steps.Step
                title='Bước 4: Kiểm tra tủ ắc quy'
                description='Kiểm tra trạng thái hoạt động, và các cảnh báo trên tủ ắc quy'
              />
              <Steps.Step
                title='Bước 5-10: Chuyển bypass'
                description='Control > Operation mode > Transfer to bypass operation > OK'
              />
              <Steps.Step title='Bước 11: OFF attomat MBB' description='OFF attomat MBB' />
              <Steps.Step
                title='Bước 12-14: Chuyển về normal'
                description='Control > Operation mode > Transfer to normal operation'
              />
        ...
        <div id='5.1.4' className='subsection'>
          <Title level={4}>5.1.4. Xử lý sự cố</Title>

          {/* Trạng thái LED */}
          <Title level={4}>Trạng thái LED và ý nghĩa</Title>
          <Card title='Trạng thái LED và ý nghĩa' style={{ marginBottom: '16px' }}>
            <Paragraph>
              Nếu màn hình không hoạt động, bạn có thể xem chế độ hoạt động của UPS thông qua các
              đèn LED trạng thái phía sau bảng điều khiển phía trước.
            </Paragraph>
            <Row gutter={[16, 16]}>
            ...
            <Title level={4}>Trạng thái LED theo từng chế độ hoạt động</Title>
          ...
          <Title level={4}>Biểu tượng trạng thái báo động</Title>
          <Card title='Biểu tượng trạng thái báo động' style={{ marginBottom: '16px' }}>
            <Paragraph>
              Chạm vào các biểu tượng trạng thái cảnh báo trên màn hình UPS để kiểm tra các cảnh
              báo:
            </Paragraph>
            <Row gutter={[16, 16]}>
                  ...
                  <Card size='small' style={{ height: '100%' }}>
                    <div
                      style={{
                        ...
                        borderRadius: '50%',
                        backgroundColor:
                          alert.color === 'Màu xanh lá cây'
                            ? '#52c41a'
                            : alert.color === 'Màu xanh lam'
                              ? '#1890ff'
                              : alert.color === 'Màu vàng'
                                ? '#faad14'
                                : '#ff4d4f',
                        marginBottom: '8px',
                      }}
          ...
          <Title level={4}>Quy trình xử lý sự cố</Title>
          ...
          {/* Hướng dẫn bảo trì */}
          <Title level={4}>Hướng dẫn bảo trì</Title>
                            ...
                            <Col xs={24} sm={12} key={i}>
                              <Card size='small' style={{ height: '100%' }}>
                                <Text
                                  strong
                                  style={{
                                    color: item.importance === 'high' ? '#fa541c' : '#1890ff',
                                  }}
                                >
                                  • {item.item}
                                </Text>
        ...
        <div id='section-5-2' className='subsection'>
          <Title level={3}>5.2. Vận hành hệ thống UPS song song</Title>

          {/* 5.2.1 Quy trình khởi động hệ thống song song */}
          <div id='5.2.1' className='subsection'>
            <Title level={4}>5.2.1. Quy trình khởi động hệ thống song song</Title>
            <Card title='Quy trình khởi động hệ thống song song' style={{ marginBottom: '16px' }}>
              <Alert
                message='Hệ thống song song'
                description='Hệ thống UPS song song tại TTDL Vân Canh với khả năng N+X redundancy.'
          ...
          <div id='5.2.2' className='subsection'>
            <Title level={4}>5.2.2. Tắt UPS ở chế độ Maintenance Bypass</Title>
            <Card title='Tắt UPS ở chế độ Maintenance Bypass' style={{ marginBottom: '16px' }}>
              ...
              <Steps direction='vertical' size='small'>
                <Steps.Step
                  title='Bước 1-3: Chuyển bypass'
                  description='Control > Transfer to bypass operation > OK'
                />
                <Steps.Step
                  title='Bước 4: Chuyển công bảng điều khiển'
                  description='Chuyển ACB từ chế độ Auto sang Manual'
                />
                <Steps.Step
                  title='Bước 5: ON Maintenance Bypass'
                  description='ON attomat Maintenance Bypass "LỘ 1600A"'
                />
                <Steps.Step
                  title='Bước 6: OFF attomat đầu ra'
                  description='OFF attomat đầu ra "LSI EDO ACB"'
                />
                <Steps.Step
                  title='Bước 7: Tắt Inverter'
                  description='Control > Inverter > Inverter OFF > OK'
                />
                ...
                <Steps.Step
                  title='Bước 10: Lặp lại cho UPS còn lại'
                  description='Lặp lại từ bước 1 đến bước 9'
                />
              </Steps>
            </Card>
          </div>
          ...
          <div id='5.2.3' className='subsection'>
            <Title level={4}>5.2.3. Bật UPS từ chế độ Maintenance Bypass</Title>
            <Card title='Bật UPS từ chế độ Maintenance Bypass' style={{ marginBottom: '16px' }}>
              <Steps direction='vertical' size='small'>
                <Steps.Step
                  title='Bước 1: ON attomat đầu vào'
                ...
                <Steps.Step
                  title='Bước 3-5: Chuyển bypass'
                  description='Control > Operation mode > Transfer to bypass operation > OK'
                />
                <Steps.Step title='Bước 6: ON attomat đầu ra' description='ON attomat đầu ra' />
                <Steps.Step
                  title='Bước 7: Lặp lại cho UPS còn lại'
                  description='Làm lại từ bước 1 tới bước 6 đối với UPS còn lại'
                />
                <Steps.Step
                  title='Bước 8: ON attomat đầu ra chính'
                  description='ON attomat đầu ra "LSI EDO ACB"'
                />
                <Steps.Step
                  title='Bước 9: OFF Maintenance Bypass'
                  description='OFF attomat Maintenance Bypass "LỘ 1600A"'
                />
                <Steps.Step
                  title='Bước 10: Bật Inverter'
                  description='Control > Inverter > Inverter ON > OK'
                />
              </Steps>
            </Card>
          </div>
          ...
          <div id='5.2.4' className='subsection'>
            <Title level={4}>5.2.4. Cách li 01 UPS khỏi hệ thống</Title>
            <Card title='Cách li 01 UPS khỏi hệ thống' style={{ marginBottom: '16px' }}>
              ...
              <Steps direction='vertical' size='small'>
                <Steps.Step
                  title='Bước 1: Kiểm tra hiện trạng'
                  description='Kiểm tra hiện trạng hoạt động của hệ thống UPS'
                />
                <Steps.Step
                  title='Bước 2-3: Truy cập Control'
                  description='Control > admin/admin'
                />
                <Steps.Step
                  title='Bước 4: Guided sequences'
                  description='Control > Guided sequences > Shut down UPS system hoặc Shut down a UPS in a parallel system'
                />
                <Steps.Step
                  title='Bước 5: Turn off inverter'
                  description='Chạm vào Turn off inverter và kiểm tra lại trạng thái'
                />
                <Steps.Step
                  title='Bước 6: OFF attomat đầu ra'
                  description='OFF attomat đầu ra, tại tủ UPS PANEL'
                />
                <Steps.Step
                  title='Bước 7: OFF attomat battery'
                  description='OFF attomat battery (đúng UPS muốn cách li)'
                />
                <Steps.Step
                  title='Bước 8: OFF attomat đầu vào'
                  description='OFF attomat đầu vào (đúng UPS muốn cách li)'
                />
              </Steps>
            </Card>
          </div>
          ...
          <div id='5.2.5' className='subsection'>
            <Title level={4}>5.2.5. Hòa 01 UPS vào hệ thống</Title>
            <Card title='Hòa 01 UPS vào hệ thống' style={{ marginBottom: '16px' }}>
              <Steps direction='vertical' size='small'>
                ...
                <Steps.Step
                  title='Bước 4: Guided sequences'
                  description='Control > Guided sequences > Start up UPS system hoặc Start up a UPS in a parallel system'
                />
                <Steps.Step title='Bước 5: ON attomat Battery' description='ON attomat Battery' />
                <Steps.Step title='Bước 6: ON attomat đầu ra' description='ON attomat đầu ra' />
                <Steps.Step
                  title='Bước 7: Turn on inverter'
                  description='Chạm vào Turn on inverter, kiểm tra lại tình trạng hoạt động'
                />
              </Steps>
            </Card>
          </div>
