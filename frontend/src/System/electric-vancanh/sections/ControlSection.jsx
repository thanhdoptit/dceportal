    ...
    <div className="content-section">
      ...
      <div id="4.1" className="subsection">
              ...
              <Col xs={24} md={12}>
                <Card size="small" title="Thông số tụ bù" style={{ borderColor: '#1890ff' }}>
                  <ul>
                    ...
                    <li><Text strong>Số bước:</Text> 8 bước</li>
                    <li><Text strong>Tổng công suất:</Text> 200kVar</li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size="small" title="Bộ điều khiển" style={{ borderColor: '#52c41a' }}>
                  <ul>
                    ...
                    <li><Text strong>Giao diện:</Text> RS485 Modbus</li>
                    <li><Text strong>Bảo vệ:</Text> Quá áp, quá dòng</li>
                  </ul>
                </Card>
              </Col>
            </Row>
        ...
        <div id="4.1.2" className="subsection">
          ...
          <Card>
            <Paragraph>
              Cài đặt và điều chỉnh hệ thống tụ bù:
            </Paragraph>
              ...
              <Col xs={24} md={12}>
                <Card size="small" title="Cài đặt thông số" style={{ borderColor: '#1890ff' }}>
                  <ul>
                    ...
                    <li><Text strong>Ngưỡng quá áp:</Text> 110%</li>
                    <li><Text strong>Ngưỡng quá dòng:</Text> 130%</li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size="small" title="Điều chỉnh tự động" style={{ borderColor: '#52c41a' }}>
                  <ul>
                    ...
                    <li><Text strong>Bước giảm:</Text> 25kVar</li>
                    <li><Text strong>Thời gian chuyển:</Text> 5s</li>
                  </ul>
                </Card>
              </Col>
            </Row>
              ...
              <Col xs={24} md={12}>
                <Card size="small" title="Thông số điện" style={{ borderColor: '#1890ff' }}>
                  <ul>
                    ...
                    <li><Text strong>Công suất:</Text> 75kW</li>
                    <li><Text strong>Tần số đầu ra:</Text> 0-400Hz</li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size="small" title="Đặc tính điều khiển" style={{ borderColor: '#52c41a' }}>
                  <ul>
                    ...
                    <li><Text strong>Thời gian tăng tốc:</Text> 0.1-3000s</li>
                    <li><Text strong>Thời gian giảm tốc:</Text> 0.1-3000s</li>
                  </ul>
                </Card>
              </Col>
            </Row>
              ...
              <Col xs={24} md={12}>
                <Card size="small" title="Thông số cơ bản" style={{ borderColor: '#1890ff' }}>
                  <ul>
                    ...
                    <li><Text strong>Dòng điện định mức:</Text> 150A</li>
                    <li><Text strong>Công suất định mức:</Text> 75kW</li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size="small" title="Thông số điều khiển" style={{ borderColor: '#52c41a' }}>
                  <ul>
                    ...
                    <li><Text strong>Thời gian giảm tốc:</Text> 10s</li>
                    <li><Text strong>Chế độ vận hành:</Text> Tự động</li>
                  </ul>
                </Card>
              </Col>
      ...
      <div id="4.3" className="subsection">
              ...
              <Col xs={24} md={12}>
                <Card size="small" title="Thông số điện" style={{ borderColor: '#1890ff' }}>
                  <ul>
                    ...
                    <li><Text strong>Điện áp điều khiển:</Text> 24V DC</li>
                    <li><Text strong>Công suất tiêu thụ:</Text> 8W</li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size="small" title="Đặc tính cơ khí" style={{ borderColor: '#52c41a' }}>
                  <ul>
                    ...
                    <li><Text strong>Tuổi thọ cơ:</Text> 10 triệu lần</li>
                    <li><Text strong>Tuổi thọ điện:</Text> 1 triệu lần</li>
                  </ul>
                </Card>
              </Col>
            </Row>
        ...
        <div id="4.3.2" className="subsection">
          ...
          <Card>
            <Paragraph>
              Quy trình lắp đặt contactor cho tụ bù:
            </Paragraph>
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} md={8}>
            <div style={{ textAlign: 'center' }}>
              <SettingOutlined style={{ fontSize: '32px', color: '#52c41a', marginBottom: '8px' }} />
              <div>Tụ bù</div>
