    ...
    <div className='content-section'>
      ...
      <div id='section-6-1' className='subsection' style={{ scrollMarginTop: '20px' }}>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <Card size='small' title='Cáp điện 3 pha' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Loại cáp:</Text> Cu/PVC/PVC
                    </li>
                    <li>
                      <Text strong>Tiết diện:</Text> 240mm², 400mm²
                    </li>
                    <li>
                      <Text strong>Điện áp:</Text> 0.6/1kV
                    </li>
                    <li>
                      <Text strong>Dòng điện:</Text> 400A, 600A
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size='small' title='Cáp điện 1 pha' className='card-green'>
                  <ul>
                    ...
                    <li>
                      <Text strong>Tiết diện:</Text> 16mm², 25mm²
                    </li>
                    <li>
                      <Text strong>Điện áp:</Text> 0.6/1kV
                    </li>
                    <li>
                      <Text strong>Dòng điện:</Text> 80A, 100A
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <div id='6.1.2' className='subsection' style={{ scrollMarginTop: '20px' }}>
          ...
          <Card style={{ marginBottom: '24px' }}>
            <Paragraph>Quy trình lắp đặt và kéo cáp điện:</Paragraph>
      ...
      <div id='section-6-2' className='subsection' style={{ scrollMarginTop: '20px' }}>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={8}>
                <Card size='small' title='Thang máng chính' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Kích thước:</Text> 600x150mm
                    </li>
                    <li>
                      <Text strong>Chất liệu:</Text> Thép mạ kẽm
                    </li>
                    <li>
                      <Text strong>Độ dày:</Text> 2.5mm
                    </li>
                    <li>
                      <Text strong>Tải trọng:</Text> 100kg/m
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={8}>
                <Card size='small' title='Thang máng nhánh' className='card-green'>
                  <ul>
                    <li>
                      <Text strong>Kích thước:</Text> 400x100mm
                    </li>
                    <li>
                      <Text strong>Chất liệu:</Text> Thép mạ kẽm
                    </li>
                    <li>
                      <Text strong>Độ dày:</Text> 2.0mm
                    </li>
                    <li>
                      <Text strong>Tải trọng:</Text> 50kg/m
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={8}>
                <Card size='small' title='Phụ kiện' className='card-orange'>
                  <ul>
                    <li>
                      <Text strong>Khớp nối:</Text> 2m/khớp
                    </li>
                    <li>
                      <Text strong>Giá đỡ:</Text> 1.5m/giá
                    </li>
                    <li>
                      <Text strong>Nút bịt:</Text> 2 đầu
                    </li>
                    <li>
                      <Text strong>Ống xuyên:</Text> Theo yêu cầu
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <div id='6.2.2' className='subsection' style={{ scrollMarginTop: '20px' }}>
          ...
          <Card style={{ marginBottom: '24px' }}>
            <Paragraph>Quy trình lắp đặt thang máng cáp:</Paragraph>
      ...
      <div id='section-6-3' className='subsection' style={{ scrollMarginTop: '20px' }}>
        ...
        <div id='6.3.1' className='subsection' style={{ scrollMarginTop: '20px' }}>
          ...
          <Card style={{ marginBottom: '24px' }}>
            <Paragraph>Quy trình kéo cáp từ thang máng đến thiết bị:</Paragraph>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <Card size='small' title='Kết nối cáp' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Đầu cáp:</Text> Đầu cosse
                    </li>
                    <li>
                      <Text strong>Kết nối:</Text> Bulong M8
                    </li>
                    <li>
                      <Text strong>Tiếp địa:</Text> Bắt buộc
                    </li>
                    <li>
                      <Text strong>Bảo vệ:</Text> Ống PVC
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size='small' title='Đánh nhãn cáp' className='card-green'>
                  <ul>
                    <li>
                      <Text strong>Loại nhãn:</Text> Nhãn dán
                    </li>
                    <li>
                      <Text strong>Nội dung:</Text> Ký hiệu cáp
                    </li>
                    <li>
                      <Text strong>Vị trí:</Text> 2 đầu cáp
                    </li>
                    <li>
                      <Text strong>Chất liệu:</Text> Chống thấm
                    </li>
                  </ul>
                </Card>
              </Col>
