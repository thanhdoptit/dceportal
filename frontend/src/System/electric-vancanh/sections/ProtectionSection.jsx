    ...
    <div className='content-section'>
      ...
      <div id='section-3-1' className='subsection'>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <Card size='small' title='Nguyên lý phát hiện' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Cảm biến ánh sáng:</Text> Phát hiện tia lửa điện
                    </li>
                    <li>
                      <Text strong>Cảm biến áp suất:</Text> Phát hiện sóng nổ
                    </li>
                    <li>
                      <Text strong>Cảm biến dòng điện:</Text> Phát hiện quá dòng
                    </li>
                    <li>
                      <Text strong>Thời gian phản ứng:</Text> ≤5ms
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size='small' title='Cơ chế bảo vệ' className='card-green'>
                  <ul>
                    <li>
                      <Text strong>Phát hiện hồ quang:</Text> Tự động
                    </li>
                    <li>
                      <Text strong>Truyền tín hiệu:</Text> Fiber optic
                    </li>
                    <li>
                      <Text strong>Thời gian cắt:</Text> ≤10ms
                    </li>
                    <li>
                      <Text strong>Bảo vệ toàn bộ:</Text> Tủ điện
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <div id='3.1.2' className='subsection'>
          ...
          <Card>
            <Paragraph>Cài đặt các thông số bảo vệ cho rơ le ARC:</Paragraph>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <Card size='small' title='Thông số cài đặt' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Độ nhạy ánh sáng:</Text> 0.1 lux
                    </li>
                    <li>
                      <Text strong>Độ nhạy áp suất:</Text> 0.1 bar
                    </li>
                    <li>
                      <Text strong>Thời gian delay:</Text> 0-1000ms
                    </li>
                    <li>
                      <Text strong>Ngưỡng dòng điện:</Text> 100A
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size='small' title='Cài đặt cảnh báo' className='card-green'>
                  <ul>
                    <li>
                      <Text strong>Đèn báo:</Text> Xanh, vàng, đỏ
                    </li>
                    <li>
                      <Text strong>Relay output:</Text> 2 cặp tiếp điểm
                    </li>
                    <li>
                      <Text strong>Giao diện:</Text> LCD + nút bấm
                    </li>
                    <li>
                      <Text strong>Truyền thông:</Text> Modbus RTU
                    </li>
                  </ul>
                </Card>
              </Col>
      ...
      <div id='section-3-2' className='subsection'>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={8}>
                <Card size='small' title='SPD Type 1' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Vị trí:</Text> Đầu vào tủ điện
                    </li>
                    <li>
                      <Text strong>Bảo vệ:</Text> Sét đánh trực tiếp
                    </li>
                    <li>
                      <Text strong>Dòng sét:</Text> 50kA (10/350μs)
                    </li>
                    <li>
              ...
              <Col xs={24} md={8}>
                <Card size='small' title='SPD Type 2' className='card-green'>
                  <ul>
                    <li>
                      <Text strong>Vị trí:</Text> Phân phối điện
                    </li>
                    <li>
                      <Text strong>Bảo vệ:</Text> Sét lan truyền
                    </li>
                    <li>
                      <Text strong>Dòng sét:</Text> 20kA (8/20μs)
                    </li>
                    <li>
                      <Text strong>Điện áp:</Text> 400V AC
                    </li>
              ...
              <Col xs={24} md={8}>
                <Card size='small' title='SPD Type 3' className='card-orange'>
                  <ul>
                    <li>
                      <Text strong>Vị trí:</Text> Thiết bị cuối
                    </li>
                    <li>
                      <Text strong>Bảo vệ:</Text> Nhiễu điện
                    </li>
                    <li>
                      <Text strong>Dòng sét:</Text> 10kA (8/20μs)
                    </li>
                    <li>
                      <Text strong>Điện áp:</Text> 230V AC
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <div id='3.2.2' className='subsection'>
          ...
          <Card>
            <Paragraph>Quy trình lắp đặt SPD theo tiêu chuẩn IEC 61643:</Paragraph>
      ...
      <div id='section-3-3' className='subsection'>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <Card size='small' title='Cấu trúc hệ thống' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Loại cọc đất:</Text> Đồng mạ kẽm
                    </li>
                    <li>
                      <Text strong>Chiều dài cọc:</Text> 3m
                    </li>
                    <li>
                      <Text strong>Số lượng cọc:</Text> 8 cọc
                    </li>
                    <li>
                      <Text strong>Khoảng cách:</Text> 3m
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size='small' title='Thông số kỹ thuật' className='card-green'>
                  <ul>
                    <li>
                      <Text strong>Điện trở đất:</Text> ≤2Ω
                    </li>
                    <li>
                      <Text strong>Tiết diện cáp:</Text> 70mm²
                    </li>
                    <li>
                      <Text strong>Chất liệu cáp:</Text> Đồng trần
                    </li>
                    <li>
                      <Text strong>Độ sâu chôn:</Text> 0.8m
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <div id='3.3.2' className='subsection'>
          ...
          <Card>
            <Paragraph>Kiểm tra và đo điện trở nối đất định kỳ:</Paragraph>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <Card size='small' title='Tiêu chuẩn đo' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Phương pháp:</Text> 3 điểm
                    </li>
                    <li>
                      <Text strong>Thiết bị đo:</Text> Earth tester
                    </li>
                    <li>
                      <Text strong>Tần số đo:</Text> 128Hz
                    </li>
                    <li>
                      <Text strong>Độ chính xác:</Text> ±2%
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size='small' title='Chu kỳ kiểm tra' className='card-green'>
                  <ul>
                    <li>
                      <Text strong>Kiểm tra định kỳ:</Text> 6 tháng
                    </li>
                    <li>
                      <Text strong>Kiểm tra sau sét:</Text> Ngay lập tức
                    </li>
                    <li>
                      <Text strong>Kiểm tra sau mưa:</Text> 24h
                    </li>
                    <li>
                      <Text strong>Ghi chép:</Text> Bắt buộc
                    </li>
                  </ul>
                </Card>
              </Col>
      ...
      <Card title='Trạng thái hệ thống bảo vệ'>
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24} md={8}>
            <div style={{ textAlign: 'center' }}>
              <ThunderboltOutlined
                style={{ fontSize: '32px', color: '#faad14', marginBottom: '8px' }}
              />
              <div>SPD</div>
