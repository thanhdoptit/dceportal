  ...
  return (
    <div className='content-section'>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <Card size='small' title='Thông số chính' className='card-blue'>
                  <ul>
                    ...
                    <li>
                      <Text strong>Dòng điện định mức:</Text> 3200A
                    </li>
                    <li>
                      <Text strong>Độ bền điện:</Text> 8kA/1s
                    </li>
                    <li>
                      <Text strong>Chuẩn bảo vệ:</Text> IP30
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size='small' title='Cấu trúc tủ' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Vỏ tủ:</Text> Thép mạ kẽm
                    </li>
                    <li>
                      <Text strong>Kích thước:</Text> 800x600x2200mm
                    </li>
                    <li>
                      <Text strong>Trọng lượng:</Text> 450kg
                    </li>
                    <li>
                      <Text strong>Màu sắc:</Text> RAL 7035
                    </li>
                  </ul>
                </Card>
              </Col>
      ...
      <div id='section-2-2' className='subsection'>
        <Title level={3}>2.2. Tủ Blokset</Title>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <Card size='small' title='Thông số điện' className='card-blue'>
                  <ul>
                    ...
                    <li>
                      <Text strong>Dòng điện:</Text> 1600A
                    </li>
                    <li>
                      <Text strong>Tần số:</Text> 50Hz
                    </li>
                    <li>
                      <Text strong>Hệ số công suất:</Text> ≥0.95
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size='small' title='Thông số cơ' className='card-green'>
                  <ul>
                    <li>
                      <Text strong>Kích thước:</Text> 600x400x2000mm
                    </li>
                    <li>
                      <Text strong>Trọng lượng:</Text> 280kg
                    </li>
                    <li>
                      <Text strong>Chuẩn bảo vệ:</Text> IP40
                    </li>
                    <li>
                      <Text strong>Vật liệu:</Text> Thép mạ kẽm
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <div id='2.2.2' className='subsection'>
          ...
          <Card title='Cấu hình và lắp đặt tủ Blokset' className='subsection'>
            <Paragraph>Quy trình cấu hình và lắp đặt tủ Blokset:</Paragraph>
      ...
      <div id='section-2-3' className='subsection'>
              ...
              <Col xs={24} md={12}>
                <Card size='small' title='Thông số điện' className='card-blue'>
                  <ul>
                    ...
                    <li>
                      <Text strong>Dòng điện:</Text> 4000A
                    </li>
                    <li>
                      <Text strong>Độ bền ngắn mạch:</Text> 65kA
                    </li>
                    <li>
                      <Text strong>Độ bền nhiệt:</Text> 65kA/1s
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <div id='2.3.2' className='subsection'>
          ...
          <Card title='Cài đặt bảo vệ ACB MTZ2' className='subsection'>
            <Paragraph>Quy trình cài đặt các thông số bảo vệ:</Paragraph>
      ...
      <div id='section-2-4' className='subsection'>
              ...
              <Col xs={24} md={12}>
                <Card size='small' title='Thông số điện' className='card-blue'>
                  <ul>
                    ...
                    <li>
                      <Text strong>Dòng điện:</Text> 63A - 800A
                    </li>
                    <li>
                      <Text strong>Độ bền ngắn mạch:</Text> 10kA - 25kA
                    </li>
                    <li>
                      <Text strong>Tiêu chuẩn:</Text> IEC 60947-2
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <div id='2.4.2' className='subsection'>
          ...
          <Card title='Cài đặt và bảo vệ MCCB' className='subsection'>
            <Paragraph>Quy trình cài đặt và cấu hình bảo vệ:</Paragraph>
      ...
      <div id='section-2-5' className='subsection'>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <Card size='small' title='Thông số điện' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Điện áp:</Text> 230V/400V AC
                    </li>
                    <li>
                      <Text strong>Dòng điện:</Text> 1A - 63A
                    </li>
                    <li>
                      <Text strong>Độ bền ngắn mạch:</Text> 6kA - 10kA
                    </li>
                    <li>
                      <Text strong>Tiêu chuẩn:</Text> IEC 60898
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <div id='2.5.2' className='subsection'>
          ...
          <Card title='Lắp đặt và kết nối MCB' className='subsection'>
            <Paragraph>Quy trình lắp đặt và kết nối MCB:</Paragraph>
              ...
              <Col xs={24} md={12}>
                ...
                >
                  <ul>
                    ...
                    <li>
                      <Text strong>Dòng điện:</Text> 6A - 63A
                    </li>
                    <li>
                      <Text strong>Độ nhạy RCD:</Text> 30mA
                    </li>
                    <li>
                      <Text strong>Độ bền ngắn mạch:</Text> 6kA
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                ...
                >
                  <ul>
                    ...
                    <li>
                      <Text strong>Dòng điện:</Text> 16A - 125A
                    </li>
                    <li>
                      <Text strong>Độ nhạy RCD:</Text> 30mA, 100mA, 300mA
                    </li>
                    <li>
                      <Text strong>Độ bền ngắn mạch:</Text> 6kA
                    </li>
