  ...
  return (
    <div className="content-section">
      ...
      <Paragraph className="section-description">
        Hệ thống điện tại Trung tâm Dữ liệu Vân Canh - VietinBank được thiết kế theo tiêu chuẩn 
        quốc tế với khả năng cung cấp điện liên tục 24/7, đảm bảo hoạt động ổn định cho các 
        thiết bị IT và hệ thống điều hòa không khí.
      </Paragraph>
      ...
      <div id="section-1-1" className="subsection">
        ...
        <Card title="Sơ đồ đơn tuyến hệ thống điện" className="subsection">
          ...
          <Paragraph>
            Hệ thống điện được thiết kế với sơ đồ đơn tuyến rõ ràng, thể hiện:
          </Paragraph>
          <ul>
        ...
        <Card title="Thông số kỹ thuật chung" className="subsection">
          <Row gutter={[16, 16]}>
            <Col xs={24} lg={12}>
              ...
              <ul>
                <li><Text strong>Điện áp lưới:</Text> 22kV</li>
                <li><Text strong>Điện áp hạ thế:</Text> 400V/230V</li>
                <li><Text strong>Tần số:</Text> 50Hz</li>
                <li><Text strong>Công suất tổng:</Text> Theo thiết kế</li>
              </ul>
            </Col>
            ...
            <Col xs={24} lg={12}>
              ...
              <ul>
                <li><Text strong>Loại nhiên liệu:</Text> Diesel</li>
                <li><Text strong>Công suất:</Text> Theo thiết kế</li>
                <li><Text strong>Điện áp:</Text> 400V/230V</li>
                <li><Text strong>Khởi động:</Text> Tự động</li>
              </ul>
            </Col>
          </Row>
          ...
          <Row gutter={[16, 16]}>
            <Col xs={24} md={12}>
              <ul>
                <li><Text strong>Loại UPS:</Text> Online Double Conversion</li>
                <li><Text strong>Điện áp đầu vào:</Text> 400V AC</li>
                <li><Text strong>Điện áp đầu ra:</Text> 400V AC</li>
                <li><Text strong>Thời gian dự phòng:</Text> Theo thiết kế</li>
              </ul>
            </Col>
            
            <Col xs={24} md={12}>
              <ul>
                <li><Text strong>Hệ thống ắc quy:</Text> VRLA hoặc Lithium</li>
                <li><Text strong>Tuổi thọ ắc quy:</Text> Theo nhà sản xuất</li>
                <li><Text strong>Hiệu suất:</Text> {'>'}95%</li>
                <li><Text strong>Bảo vệ:</Text> Quá tải, ngắn mạch</li>
              </ul>
            </Col>
          </Row>
        </Card>
      ...
      <div id="section-1-4" className="subsection">
        ...
        <Card title="Tiêu chuẩn và quy định" className="subsection">
          ...
          <Paragraph>
            Các thiết bị sử dụng trong hệ thống đều có chứng nhận chất lượng:
          </Paragraph>
          <ul>
        ...
        <Card title="Thông tin dự án" className="subsection">
          <Row gutter={[16, 16]}>
            <Col xs={24} lg={12}>
              ...
              <ul>
                <li><Text strong>Dự án:</Text> Đầu tư hạ tầng công nghệ Trung tâm Dữ liệu VietinBank</li>
                <li><Text strong>Gói thầu:</Text> Cung cấp, triển khai hệ thống điện</li>
                <li><Text strong>Địa điểm:</Text> Xã Vân Canh, Huyện Hoài Đức, TP. Hà Nội</li>
                <li><Text strong>Chủ đầu tư:</Text> Ngân hàng TMCP Công thương Việt Nam</li>
              </ul>
            </Col>
            ...
            <Col xs={24} lg={12}>
              ...
              <ul>
                <li><Text strong>Nhà thầu thi công:</Text> Công ty CP Kỹ thuật Công nghiệp Á Châu</li>
                <li><Text strong>Tư vấn giám sát:</Text> Tổng công ty Tư vấn Xây dựng Việt Nam</li>
                <li><Text strong>Thời gian:</Text> Theo tiến độ dự án</li>
                <li><Text strong>Trạng thái:</Text> Đã hoàn thành và đưa vào vận hành</li>
              </ul>
            </Col>
          </Row>
        </Card>
