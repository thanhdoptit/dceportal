    ...
    <div className='content-section'>
      ...
      <div id='section-5-1' className='subsection' style={{ scrollMarginTop: '20px' }}>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={8}>
                <Card size='small' title='Đèn LED Panel' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Công suất:</Text> 18W, 24W, 36W
                    </li>
                    <li>
                      <Text strong>Quang thông:</Text> 1800-3600lm
                    </li>
                    <li>
                      <Text strong>Nhiệt độ màu:</Text> 4000K
                    </li>
                    <li>
                      <Text strong>Tuổi thọ:</Text> 50,000 giờ
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={8}>
                <Card size='small' title='Đèn LED Tube' className='card-green'>
                  <ul>
                    <li>
                      <Text strong>Công suất:</Text> 9W, 18W
                    </li>
                    <li>
                      <Text strong>Quang thông:</Text> 900-1800lm
                    </li>
                    <li>
                      <Text strong>Nhiệt độ màu:</Text> 6500K
                    </li>
                    <li>
                      <Text strong>Tuổi thọ:</Text> 30,000 giờ
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={8}>
                <Card size='small' title='Đèn LED Downlight' className='card-orange'>
                  <ul>
                    <li>
                      <Text strong>Công suất:</Text> 12W, 18W
                    </li>
                    <li>
                      <Text strong>Quang thông:</Text> 1200-1800lm
                    </li>
                    <li>
                      <Text strong>Góc chiếu:</Text> 120°
                    </li>
                    <li>
                      <Text strong>Tuổi thọ:</Text> 40,000 giờ
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <div id='5.1.2' className='subsection' style={{ scrollMarginTop: '20px' }}>
          ...
          <Card style={{ marginBottom: '24px' }}>
            <Paragraph>Hệ thống điều khiển chiếu sáng thông minh:</Paragraph>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <Card size='small' title='Hệ thống điều khiển' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Điều khiển tự động:</Text> Theo thời gian
                    </li>
                    <li>
                      <Text strong>Cảm biến chuyển động:</Text> PIR sensor
                    </li>
                    <li>
                      <Text strong>Cảm biến ánh sáng:</Text> LDR sensor
                    </li>
                    <li>
                      <Text strong>Giao diện:</Text> Touch panel
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size='small' title='Bố trí chiếu sáng' className='card-green'>
                  <ul>
                    <li>
                      <Text strong>Khu vực làm việc:</Text> 500 lux
                    </li>
                    <li>
                      <Text strong>Khu vực hành lang:</Text> 200 lux
                    </li>
                    <li>
                      <Text strong>Khu vực kho:</Text> 300 lux
                    </li>
                    <li>
                      <Text strong>Khu vực vệ sinh:</Text> 150 lux
                    </li>
                  </ul>
                </Card>
              </Col>
      ...
      <div id='section-5-2' className='subsection' style={{ scrollMarginTop: '20px' }}>
              ...
              <Col xs={24} md={12}>
                <Card size='small' title='Ổ cắm 3 pha' className='card-blue'>
                  <ul>
                    ...
                    <li>
                      <Text strong>Dòng điện:</Text> 32A, 63A
                    </li>
                    <li>
                      <Text strong>Chuẩn bảo vệ:</Text> IP44
                    </li>
                    <li>
                      <Text strong>Kết nối:</Text> Screw terminal
                    </li>
                  </ul>
                </Card>
              </Col>
              <Col xs={24} md={12}>
                <Card size='small' title='Ổ cắm 1 pha' className='card-green'>
                  <ul>
                    ...
                    <li>
                      <Text strong>Dòng điện:</Text> 16A, 32A
                    </li>
                    <li>
                      <Text strong>Chuẩn bảo vệ:</Text> IP44
                    </li>
                    <li>
                      <Text strong>Bảo vệ:</Text> RCD tích hợp
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <div id='5.2.2' className='subsection' style={{ scrollMarginTop: '20px' }}>
          ...
          <Card style={{ marginBottom: '24px' }}>
            <Paragraph>Quy trình lắp đặt ổ cắm và công tắc:</Paragraph>
      ...
      <div id='section-5-3' className='subsection' style={{ scrollMarginTop: '20px' }}>
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} md={12}>
                <Card size='small' title='Đèn Exit' className='card-blue'>
                  <ul>
                    <li>
                      <Text strong>Loại đèn:</Text> LED Exit sign
                    </li>
                    <li>
                      <Text strong>Công suất:</Text> 3W
                    </li>
                    <li>
                      <Text strong>Nguồn điện:</Text> 230V AC
                    </li>
                    <li>
                      <Text strong>Tuổi thọ:</Text> 50,000 giờ
                    </li>
              ...
              <Col xs={24} md={12}>
                <Card size='small' title='Đèn Emergency' className='card-green'>
                  <ul>
                    <li>
                      <Text strong>Loại đèn:</Text> LED Emergency
                    </li>
                    <li>
                      <Text strong>Công suất:</Text> 5W, 10W
                    </li>
                    <li>
                      <Text strong>Nguồn dự phòng:</Text> 3 giờ
                    </li>
                    <li>
                      <Text strong>Quang thông:</Text> 500-1000lm
                    </li>
                  </ul>
                </Card>
              </Col>
        ...
        <div id='5.3.2' className='subsection' style={{ scrollMarginTop: '20px' }}>
          ...
          <Card style={{ marginBottom: '24px' }}>
            <Paragraph>Hệ thống điều khiển đèn Exit và Emergency:</Paragraph>
              ...
              <Col xs={24} md={12}>
                <Card size='small' title='Điều khiển tự động' className='card-blue'>
                  <ul>
                    ...
                    <li>
                      <Text strong>Thời gian sáng:</Text> 3 giờ
                    </li>
                    <li>
                      <Text strong>Cảm biến mất điện:</Text> Tự động
                    </li>
                    <li>
                      <Text strong>Kiểm tra định kỳ:</Text> Hàng tháng
                    </li>
                  </ul>
                </Card>
              </Col>
