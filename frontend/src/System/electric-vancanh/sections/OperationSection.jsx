  ...
  return (
    <div className='content-section'>
      ...
      <Paragraph className='section-description'>
        Quy trình vận hành, kiểm tra hệ thống dự phòng và bảo trì định kỳ hệ thống điện tại Trung
        tâm Dữ liệu Vân Canh - VietinBank.
      </Paragraph>
      ...
      <div id='section-7-1' className='subsection'>
        ...
        <Card title='Quy trình vận hành hệ thống điện' className='subsection'>
          <Paragraph>
            Quy trình khởi động và vận hành hệ thống điện theo 4 bước chuẩn, đảm bảo an toàn và hiệu
            quả.
          </Paragraph>
          ...
          <Row gutter={[16, 16]} style={{ marginTop: '24px' }}>
            ...
            <Col xs={24} lg={12}>
              ...
              <ul>
                <li>
                  <Text strong>Điện áp:</Text> 400V ±5%
                </li>
                <li>
                ...
                <li>
                  <Text strong>Nhiệt độ tủ:</Text> ≤45°C
                </li>
                <li>
                  <Text strong>Độ ẩm:</Text> ≤85%
                </li>
              </ul>
            </Col>
          </Row>
        ...
        <Card title='Kiểm tra hệ thống điện dự phòng' className='subsection'>
          ...
          <Row gutter={[16, 16]} style={{ marginTop: '16px' }}>
            <Col xs={24} lg={12}>
              ...
              <ul>
                <li>
                  <Text strong>Bước 1-2:</Text> 5-10 phút
                </li>
                <li>
                  <Text strong>Bước 3-4:</Text> 10-15 phút
                </li>
                <li>
                  <Text strong>Bước 5-6:</Text> 15-20 phút
                </li>
                <li>
                  <Text strong>Bước 7:</Text> 5-10 phút
                </li>
                <li>
                  <Text strong>Tổng thời gian:</Text> 45-60 phút
                </li>
              </ul>
            </Col>
