...
export const ElectricDataProvider = ({ children }) => {
      ...
      try {
        ...
        const introductionData = {
          ...
          standards: [
            {
              id: 'std-1',
              name: 'TCVN 5935-1:2013',
              description: 'Hệ thống điện hạ áp',
              compliance: '100%',
            },
        ...
        const controlData = {
          ...
          generatorControl: [
            {
              id: 'gen-1',
              name: 'Điều khiển máy phát 1',
              type: 'Auto Start',
              status: 'operational',
            },
            {
              id: 'gen-2',
              name: 'Điều khiển máy phát 2',
              type: 'Auto Start',
              status: 'operational',
            },
          ],
          ...
          vietnameseStandards: [
            {
              id: 'vn-1',
              name: 'TCVN 5935-1:2013',
              title: 'Hệ thống điện hạ áp',
              compliance: '100%',
            },
            {
              id: 'vn-2',
              name: 'QCVN 4:2009',
              title: 'Quy chuẩn kỹ thuật điện',
              compliance: '100%',
            },
          ],
          internationalStandards: [
  ...
  const getSystemStatus = useCallback(() => {
    const operationalPanels = systemData.lowVoltage.acitPanels.filter(
      panel => panel.status === 'operational'
    ).length;
  ...
  const getMaintenanceSchedule = useCallback(() => {
    return systemData.operation.maintenanceSchedules.filter(
  ...
  return <ElectricDataContext.Provider value={value}>{children}</ElectricDataContext.Provider>;
};
