        ...
        <Card title='Hiệu quả chính của dự án' style={{ marginBottom: '20px' }}>
          <Space direction='vertical' size='middle' style={{ width: '100%' }}>
            <div>
              ...
              <Text>
                Đảm bảo hoạt động liên tục cho hạ tầng trung tâm dữ liệu VietinBank với độ tin cậy
            ...
            <div>
              ...
              <Text>
                Sẵn sàng hạ tầng để triển khai hệ thống CNTT, phát triển dịch vụ nhanh chóng
              </Text>
            </div>
            <div>
        ...
        <Card title='Rủi ro thiết bị trên mái' style={{ marginBottom: '20px' }}>
          <Space direction='vertical' size='middle' style={{ width: '100%' }}>
            ...
            <div>
              ...
              <Text>
                Mưa bão, sấm sét, nắng nóng có thể làm giảm tuổi thọ, mau hư hỏng thiết bị
              </Text>
            </div>
            <div>
        ...
        <Card title='Rủi ro nguồn điện' style={{ marginBottom: '20px' }}>
          <Space direction='vertical' size='middle' style={{ width: '100%' }}>
            ...
            <div>
              ...
              <Text>
                Nguy cơ ngấm dột qua trục kỹ thuật gây hư hỏng thiết bị điện tại tầng 1, tầng 2
              </Text>
            </div>
          </Space>
        </Card>
        ...
        <Card title='Rủi ro nhân sự' style={{ marginBottom: '20px' }}>
          <Space direction='vertical' size='middle' style={{ width: '100%' }}>
            <div>
              ...
              <Text>
                Nhân sự kỹ thuật cao quản lý vận hành còn mỏng so với quy mô và độ phức tạp
              </Text>
            </div>
            <div>
              <Tag color='red'>⚠️ Chuyên môn</Tag>
              <Text>
                Cán bộ kỹ thuật phòng Quản trị chưa có để đảm bảo vận hành xử lý sự cố phần hệ thống
                nguồn cung cấp
              </Text>
            </div>
          </Space>
        ...
        <Card title='Rủi ro công suất' style={{ marginBottom: '20px' }}>
          <Space direction='vertical' size='middle' style={{ width: '100%' }}>
            <div>
              ...
              <Text>
                Mật độ công suất các hệ thống máy chủ blade, máy chủ AI tăng cao đột biến lên tới
                20-25 KW/thiết bị
              </Text>
            </div>
            <div>
        ...
        <Card title='Giải pháp nhân sự' style={{ marginBottom: '20px' }}>
          <Space direction='vertical' size='middle' style={{ width: '100%' }}>
            ...
            <div>
              ...
              <Text>
                Dần nắm bắt cả phần nguồn cung cấp: trạm biến áp, máy phát điện, hệ thống cấp dầu
              </Text>
            </div>
          </Space>
        </Card>
        ...
        <Card title='Giải pháp công suất' style={{ marginBottom: '20px' }}>
          <Space direction='vertical' size='middle' style={{ width: '100%' }}>
            <div>
              ...
              <Text>
                Giám sát, đánh giá kỹ lưỡng công suất tải thực tế của các hệ thống công suất cao
              </Text>
            </div>
            <div>
            ...
            <div>
              ...
              <Text>
                Có kế hoạch xây dựng khu vực riêng với diện tích nhỏ, đáp ứng công suất siêu cao,
                mật độ, băng thông mạng siêu cao tại tầng 3
              </Text>
            </div>
          </Space>
        </Card>
