import { PictureOutlined, SafetyOutlined } from '@ant-design/icons';
  ...
  return (
    <div id='section-5' className='content-section'>
      ...
      <div id='section-5-1' className='subsection'>
        <Title level={3}>
          <SafetyOutlined style={{ marginRight: '8px' }} /> 5.1 HỆ THỐNG PCCC TỰ ĐỘNG BẰNG KHÍ NOVEC
          1230
        </Title>
        ...
        >
          ...
          >
            HỆ THỐNG PCCC TỤ ĐỘNG BẰNG KHÍ NOVEC 1230 KÈM HỆ THỐNG BÁO KHÓI SỚM, HỆ THỐNG GIÁM SÁT
            ĐỒ HỌA.
          </p>
        </Card>
