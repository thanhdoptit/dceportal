...
export const VanCanhDataProvider = ({ children }) => {
  ...
  useEffect(() => {
    const loadAllDataSequentially = async () => {
      try {
        ...
        const overviewData = {
          milestones: [
            { id: 'milestone-1', name: 'Khởi công xây dựng', date: '2023-01-01', status: 'completed' },
            { id: 'milestone-2', name: 'Hoàn thành cơ sở hạ tầng', date: '2023-06-01', status: 'completed' },
            { id: 'milestone-3', name: 'Lắp đặt thiết bị', date: '2023-09-01', status: 'completed' },
            { id: 'milestone-4', name: 'Vận hành thử nghiệm', date: '2023-12-01', status: 'completed' }
          ],
          standards: [
          ...
          comparisons: [
            { id: 'comparison-1', metric: 'Uptime', target: '99.982%', current: '99.985%', status: 'exceeded' },
            { id: 'comparison-2', metric: 'PUE', target: '1.4', current: '1.35', status: 'exceeded' },
            { id: 'comparison-3', metric: 'WUE', target: '0.5', current: '0.45', status: 'exceeded' }
          ]
        };
        ...
        const architectureData = {
          ...
          standards: [
            { id: 'standard-1', name: 'Hot/Cold Aisle', implementation: '100%', efficiency: 'high' },
          ...
          design: [
            { id: 'design-1', name: 'Modular Design', features: ['Scalable', 'Flexible', 'Efficient'] },
            { id: 'design-2', name: 'Green Building', features: ['LEED Certified', 'Energy Efficient', 'Sustainable'] }
          ]
        };
        ...
        const powerData = {
          substations: [
            { id: 'substation-1', name: 'Main Substation', capacity: '20 MVA', status: 'operational' },
            { id: 'substation-2', name: 'Backup Substation', capacity: '20 MVA', status: 'standby' }
          ],
          ups: [
            { id: 'ups-1', name: 'UPS System A', capacity: '2 MW', runtime: '15 minutes', status: 'operational' },
            { id: 'ups-2', name: 'UPS System B', capacity: '2 MW', runtime: '15 minutes', status: 'operational' }
          ],
          distribution: [
        ...
        const coolingData = {
          ...
          pacs: [
            { id: 'pac-1', name: 'PAC UNIFLAIR', capacity: '50 kW', quantity: 20, status: 'operational' },
            { id: 'pac-2', name: 'PAC APC', capacity: '45 kW', quantity: 15, status: 'operational' }
          ],
          tes: [
            { id: 'tes-1', name: 'TES Tank', capacity: '360 tons', backupTime: '10 minutes', status: 'operational' }
          ]
        };
        ...
        const fireProtectionData = {
          ...
          smokeDetection: [
            { id: 'smoke-1', name: 'Early Warning System', sensitivity: 'high', coverage: '100%', status: 'operational' }
          ],
          monitoring: [
            { id: 'monitor-1', name: 'Graphic Monitoring', features: ['Real-time', 'Alarm', 'Logging'], status: 'operational' }
          ]
        };
        ...
        const securityData = {
          cctv: [
            { id: 'cctv-1', name: 'CCTV System', cameras: 50, coverage: '100%', status: 'operational' }
          ],
          accessControl: [
            { id: 'acs-1', name: 'Access Control System', readers: 20, coverage: '100%', status: 'operational' }
          ],
          pa: [
            { id: 'pa-1', name: 'Public Address System', speakers: 30, coverage: '100%', status: 'operational' }
          ]
        };
        ...
        const networkData = {
          fiber: [
            { id: 'fiber-1', name: 'Fiber Optic Network', capacity: '100 Gbps', redundancy: 'dual', status: 'operational' }
          ],
          copper: [
            { id: 'copper-1', name: 'Copper Network', capacity: '10 Gbps', redundancy: 'dual', status: 'operational' }
          ],
          activeActive: [
            { id: 'active-1', name: 'Active-Active Design', availability: '99.99%', loadBalancing: 'enabled', status: 'operational' }
          ]
        };
        ...
        const rackData = {
          servers: [
            { id: 'rack-1', name: 'Server Racks', quantity: 1000, utilization: '85%', status: 'operational' }
          ],
          capacity: [
            { id: 'capacity-1', name: 'Power Capacity', total: '10 MW', used: '8.5 MW', available: '1.5 MW' },
            { id: 'capacity-2', name: 'Cooling Capacity', total: '12 MW', used: '10 MW', available: '2 MW' }
          ],
          containment: [
            { id: 'containment-1', name: 'Hot Aisle Containment', coverage: '100%', efficiency: 'high', status: 'operational' }
          ]
        };
        ...
        const riskData = {
          effectiveness: [
            ...
            { id: 'eff-2', name: 'Operational Efficiency', score: 92, target: 85, status: 'exceeded' },
            { id: 'eff-3', name: 'Cost Efficiency', score: 88, target: 80, status: 'exceeded' }
          ],
          risks: [
            { id: 'risk-1', name: 'Power Outage', probability: 'low', impact: 'high', mitigation: 'UPS + Generator' },
            { id: 'risk-2', name: 'Cooling Failure', probability: 'low', impact: 'high', mitigation: 'Redundant Systems' },
            { id: 'risk-3', name: 'Network Downtime', probability: 'very low', impact: 'medium', mitigation: 'Active-Active' }
          ],
          solutions: [
            ...
            { id: 'solution-3', name: 'Maintenance', implementation: 'Preventive', effectiveness: 'high' }
          ]
        };
  ...
  const getSystemsByType = useCallback((type) => {
  ...
  const getRiskLevel = useCallback(() => {
    const highRisks = systemData.risk.risks.filter(risk => risk.probability === 'high' || risk.impact === 'high');
  ...
  return (
    <VanCanhDataContext.Provider value={value}>
      {children}
    </VanCanhDataContext.Provider>
  );
};
