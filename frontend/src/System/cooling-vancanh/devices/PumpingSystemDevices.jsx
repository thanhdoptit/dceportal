import { EyeOutlined, InfoCircleOutlined, ToolOutlined } from '@ant-design/icons';
      ...
      <div id='2.6.13' style={{ scrollMarginTop: '20px' }}>
        <Alert
          ...
          description={
            <div>
              <p>
                <strong>Kiểm tra trước vận hành:</strong> Đảm bảo đầy nước trong bơm, kiểm tra áp
                suất hệ thống, xả khí trong đường ống.
              </p>
              <p>
                <strong>Vận hành an toàn:</strong> Luôn mở van từ từ, tránh shock áp suất đột ngột,
                kiểm tra rung động bơm.
              </p>
              <p>
                <strong>Bảo trì định kỳ:</strong> Kiểm tra bearing, mechanical seal, rung động bơm
                hàng tháng, thay dầu bôi trơn.
              </p>
              <p>
                <strong>Giám sát năng lượng:</strong> Theo dõi BTU meter để tối ưu hóa hiệu suất làm
                lạnh, phân tích chi phí vận hành.
              </p>
              <p>
                <strong>Hóa chất:</strong> Kiểm tra pH (7.5-8.5), độ dẫn điện và mức hóa chất trong
                hệ thống, bổ sung định kỳ.
              </p>
              <p>
                <strong>TES Tank:</strong> Giám sát nhiệt độ và mức nước trong TES tank, đảm bảo khả
                năng dự phòng 10 phút.
              </p>
              <p>
                <strong>Van cân bằng:</strong> Kiểm tra và điều chỉnh van cân bằng theo tải thực tế,
                đảm bảo phân phối nước đều.
              </p>
            </div>
          }
          type='warning'
