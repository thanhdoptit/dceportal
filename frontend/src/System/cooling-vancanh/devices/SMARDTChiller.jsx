    ...
    <div id="section-2.1" className="device-section">
      ...
      <div id="section-2.1.1" className="subsection">
        ...
        <Card title="Đặc điểm kỹ thuật nổi bật" style={{ marginBottom: '20px' }}>
          <Paragraph>
            <ul>
              <li><Text strong>Công nghệ Oil-free:</Text> Máy nén không dầu, giảm thiểu bảo trì và tăng tuổi thọ</li>
              <li><Text strong>Hiệu suất cao:</Text> COP đạt 3.5, tiết kiệm 30% năng lượng so với chiller thông thường</li>
              <li><Text strong>Điều khiển thông minh:</Text> PLC tích hợp với giao diện màn hình cảm ứng</li>
              <li><Text strong>Vận hành ổn định:</Text> 2 máy nén song song, đảm bảo độ tin cậy cao</li>
              <li><Text strong>Bảo trì dễ dàng:</Text> Thiết kế module hóa, dễ dàng thay thế linh kiện</li>
              <li><Text strong>Tích hợp BMS:</Text> Giao tiếp Modbus RTU, tích hợp với hệ thống BMS</li>
            </ul>
          </Paragraph>
        </Card>
        ...
        <Card title="Control Logic - Logic điều khiển hệ thống" style={{ marginBottom: '20px' }}>
          ...
          <Paragraph>
            <ul>
              ...
              <li>Van 3A & 3B: <Tag color="green">Mở hoàn toàn</Tag></li>
              <li>Van 2A & 2B: <Tag color="green">Mở hoàn toàn</Tag></li>
              <li>Nước từ chiller chỉ đi qua Két dự phòng TES</li>
              <li>Nước lưu trữ trong TES được duy trì ở <Text strong>10°C</Text></li>
              <li>Khi nước ở đỉnh TES đạt <Text strong>10°C</Text> thì chuyển về chế độ BÌNH THƯỜNG</li>
            </ul>
          </Paragraph>
          ...
          <Paragraph>
            <ul>
              ...
              <li>Van 3A & 3B: <Tag color="red">Đóng</Tag></li>
              <li>Van 2A & 2B: <Tag color="red">Đóng</Tag></li>
              <li>Van 1A & 1B: <Tag color="green">Mở hoàn toàn</Tag></li>
              <li>Nước lạnh <Text strong>10°C</Text> từ Chiller → TES qua van 1A & 1B (đỉnh két)</li>
              <li>Nước <Text strong>10°C</Text> từ đáy két → CRAC</li>
            </ul>
          </Paragraph>
          ...
          <Paragraph>
            <ul>
              ...
              <li>Nhiệt độ nước vào TES tăng dần đến <Text strong>10°C</Text></li>
              <li>Nước vào Chiller: <Text strong>~16°C</Text></li>
              <li>Nước ra Chiller: <Text strong>~16°C</Text></li>
              <li>Nước từ TES vẫn duy trì <Text strong>10°C</Text> đến CRAC</li>
              <li>Thời gian dự phòng: <Text strong>10 phút</Text></li>
            </ul>
          </Paragraph>
          ...
          <Paragraph>
            <ul>
              ...
              <li>Van 3A & 3B: <Tag color="green">Mở 100%</Tag></li>
              <li>Van 2A & 2B: <Tag color="orange">Điều tiết theo tải</Tag> (tối thiểu 10%)</li>
              <li>Tải lạnh DC = 70% → Van 2A & 2B mở 30%</li>
              <li>Van 1A & 1B: <Tag color="red">Đóng</Tag></li>
        ...
        <Card title="Quy trình khởi động hệ thống" style={{ marginBottom: '20px' }}>
            ...
            <ol>
              <li><Text strong>Ra lệnh bật Chiller 01</Text>
                <ul>
                  ...
                  <li>Thứ tự Chiller được tính toán để tổng thời gian hoạt động tương đương nhau</li>
                </ul>
              </li>
              <li><Text strong>Ra lệnh mở van chặn Chiller 01</Text>
                <ul>
                  <li>BMS theo dõi tín hiệu gọi cấp nước lạnh từ bộ điều khiển Chiller</li>
                  <li>Ra lệnh đóng/mở van chặn của mỗi Chiller</li>
                </ul>
              </li>
              <li><Text strong>Ra lệnh bật bơm nước lạnh</Text>
                <ul>
          ...
          <Paragraph>
            <ul>
              ...
              <li><Tag color="green">Mở hoàn toàn Van V2A, V2B</Tag></li>
              <li><Tag color="green">Mở hoàn toàn Van V3A, V3B</Tag></li>
            </ul>
          </Paragraph>
        ...
        <Card title="Quy trình vận hành chế độ BÌNH THƯỜNG" style={{ marginBottom: '20px' }}>
          ...
          <Paragraph>
            <ul>
              ...
              <li><Text strong>Vận hành TES chế độ Commissioning:</Text> Cho tới khi nhiệt độ tại đỉnh TES đạt 10°C thì chuyển sang chế độ BÌNH THƯỜNG</li>
              <li><Text strong>Vận hành TES chế độ BÌNH THƯỜNG:</Text>
                <ul>
                  <li><Tag color="green">Mở hoàn toàn Van V1A, V1B</Tag></li>
                  <li><Tag color="red">Đóng hoàn toàn Van V2A, V2B</Tag></li>
                  <li><Tag color="red">Đóng hoàn toàn Van V3A, V3B</Tag></li>
                </ul>
              </li>
              <li><Text strong>Vận hành hệ thống van Bypass:</Text> Tiếp tục từ quy trình khởi động</li>
              <li><Text strong>Vận hành hệ thống bơm bù:</Text> Tiếp tục từ quy trình khởi động</li>
            </ul>
          </Paragraph>
          ...
          <Paragraph>
            <ul>
              ...
              <li>Thời gian luân phiên mặc định: <Text strong>8h</Text></li>
            </ul>
          </Paragraph>
        </Card>
        ...
        <Card title="Quy trình vận hành chế độ SỰ CỐ" style={{ marginBottom: '20px' }}>
          ...
          <Paragraph>
            <ol>
              ...
              <li><Text strong>Khắc phục sự cố nguồn:</Text> Khởi động lại hệ thống Chiller</li>
              <li><Text strong>Vận hành TES chế độ NẠP:</Text> Cho tới khi nhiệt độ đỉnh TES đạt 10°C</li>
              <li><Text strong>Vận hành TES chế độ BÌNH THƯỜNG:</Text> Sau khi đạt nhiệt độ cài đặt</li>
            </ol>
          </Paragraph>
        </Card>
        ...
        <Card title="Các chế độ vận hành" style={{ marginBottom: '20px' }}>
          ...
          <Paragraph>
            <ul>
              ...
              <li><Text strong>Tham số cài đặt:</Text>
                <ul>
        ...
        <Card title="Kiểm tra hàng ngày" style={{ marginBottom: '20px' }}>
          ...
          <Table
            dataSource={[
              ...
              { key: '2', parameter: 'Nhiệt độ nước lạnh vào', normal: '16°C', check: 'Ghi chép và so sánh' },
              { key: '3', parameter: 'Áp suất nước lạnh', normal: '3-4 bar', check: 'Kiểm tra đồng hồ' },
              ...
              { key: '7', parameter: 'Nhiệt độ dầu', normal: '60-80°C', check: 'Kiểm tra cảm biến' },
            ]}
            columns={[
              {
                title: 'Thông số',
