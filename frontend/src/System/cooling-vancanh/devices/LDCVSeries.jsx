    ...
    <div>
      <div id='section-2-3' className='subsection'>
        ...
        <div id='section-2.3.1' className='subsection'>
          ...
          <Card title='Đặc điểm kỹ thuật nổi bật' style={{ marginBottom: '20px' }}>
            <Paragraph>
              <ul>
                <li>
                  <Text strong>Công suất lớn:</Text> Phù hợp cho phòng server có tải nhiệt cao
                </li>
                <li>
                  <Text strong>Hiệu suất tối ưu:</Text> Thiết kế tối ưu cho môi trường datacenter
                </li>
                <li>
                  <Text strong>Điều khiển thông minh:</Text> Hệ thống điều khiển tiên tiến
                </li>
                <li>
                  <Text strong>Tích hợp BMS:</Text> Giao tiếp Modbus, tích hợp hệ thống giám sát
                </li>
                <li>
                  <Text strong>Vận hành ổn định:</Text> Thiết kế robust cho vận hành 24/7
                </li>
                <li>
                  <Text strong>Bảo trì dễ dàng:</Text> Cấu trúc module, dễ dàng thay thế linh kiện
                </li>
              </ul>
            </Paragraph>
          </Card>
        ...
        <div id='section-2.3.3' className='subsection'>
          <Title level={4}>
            <ToolOutlined style={{ marginRight: '8px' }} /> 2.3.3. Hướng dẫn vận hành và kiểm tra
            hàng ngày
          </Title>
          ...
          <Card title='Kiểm tra hàng ngày' style={{ marginBottom: '20px' }}>
            ...
            <Table
              dataSource={[
                {
                  key: '1',
                  parameter: 'Nhiệt độ phòng',
                  normal: '22±2°C',
                  check: 'Đọc cảm biến nhiệt độ',
                },
                {
                  key: '2',
                  parameter: 'Độ ẩm phòng',
                  normal: '45-55%',
                  check: 'Đọc cảm biến độ ẩm',
                },
                {
                  key: '3',
                  parameter: 'Nhiệt độ gió cấp',
                  normal: '16-18°C',
                  check: 'Đọc cảm biến gió cấp',
                },
                ...
                },
                {
                  ...
                  check: 'Kiểm tra van gió',
                },
                {
                  key: '8',
                  parameter: 'Nhiệt độ các điểm trong phòng',
                  normal: '22±3°C',
                  check: 'Đo nhiệt độ tại các vị trí',
                },
              ]}
              columns={[
                {
