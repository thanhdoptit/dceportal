    ...
    <div>
      <div id='section-2-2' className='subsection'>
        ...
        <div id='section-2.2.1' className='subsection'>
          ...
          <Card title='Đặc điểm kỹ thuật nổi bật' style={{ marginBottom: '20px' }}>
            <Paragraph>
              <ul>
                <li>
                  <Text strong>Độ chính xác cao:</Text> Kiểm soát nhiệt độ ±0.5°C, độ ẩm 45-55%
                </li>
                <li>
                  <Text strong>Tiết kiệm năng lượng:</Text> Sử dụng công nghệ inverter tiên tiến
                </li>
                <li>
                  <Text strong>Vận hành ổn định:</Text> Thiết kế robust, phù hợp môi trường
                  datacenter
                </li>
                <li>
                  <Text strong>Dễ bảo trì:</Text> Cấu trúc module, dễ dàng thay thế linh kiện
                </li>
                <li>
                  <Text strong>Tích hợp BMS:</Text> Giao tiếp Modbus, tích hợp hệ thống giám sát
                </li>
                <li>
                  <Text strong>Độ tin cậy cao:</Text> Thiết kế cho vận hành 24/7
                </li>
              </ul>
            </Paragraph>
          </Card>
        ...
        <div id='section-2.2.3' className='subsection'>
          <Title level={4}>
            <ToolOutlined style={{ marginRight: '8px' }} /> 2.2.3. Hướng dẫn vận hành và kiểm tra
            hàng ngày
          </Title>
        ...
        <div id='section-2.2.4' className='subsection'>
          <Title level={4}>
            <ExclamationCircleOutlined style={{ marginRight: '8px' }} /> 2.2.4. Hướng dẫn xác định
            nguyên nhân lỗi
          </Title>
