    ...
    <div>
      <div id='section-2-5' className='subsection'>
        ...
        <div id='section-2.5.1' className='subsection'>
          ...
          <Card
            title='Thông tin cơ bản hệ thống BMS Chiller TTDL Vân Canh'
            style={{ marginBottom: '20px' }}
          >
          ...
          <Card
            title='Thành phần hệ thống BMS Chiller TTDL Vân Canh'
            style={{ marginBottom: '20px' }}
          >
            <Table
              dataSource={[
                {
                  ...
                  function: 'Điều khiển trung tâm toàn hệ thống',
                  location: 'Tủ điều khiển chính tại Electrical Room',
                },
                {
                  key: '2',
                  component: 'HMI Touch Panel',
                  function: 'Giao diện vận hành và giám sát',
                  location: 'Phòng điều khiển NOC',
                },
                {
                  key: '3',
                  component: 'SMARDT Chiller Controller',
                  function: 'Điều khiển Chiller AE054.2B.F2HAJA.A010DX.E10',
                  location: 'Chiller outdoor',
                },
                {
                  key: '4',
                  component: 'TES Tank Control System',
                  function: 'Điều khiển kết dự phòng 10 phút',
                  location: 'Utility Room',
                },
                {
                  key: '5',
                  component: 'Temperature Sensors (TT)',
                  function: 'Đo nhiệt độ nước lạnh cấp/hồi',
                  location: 'Các đường ống chính',
                },
                {
                  key: '6',
                  component: 'Pressure Sensors (PT)',
                  function: 'Đo áp suất hệ thống nước lạnh',
                  location: 'Header chính và phụ',
                },
                {
                  key: '7',
                  component: 'Flow Meters (FIT)',
                  function: 'Đo lưu lượng nước lạnh realtime',
                  location: 'Main header và branch',
                },
                {
                  key: '8',
                  component: 'Modbus RTU Gateway',
                  function: 'Giao tiếp với UNIFLAIR PAC',
                  location: 'Control cabinet',
                },
                {
                  key: '9',
                  component: 'Van điều khiển 3-way (V1A/V1B/V2A/V2B/V3A/V3B)',
                  function: 'Điều khiển chế độ TES',
                  location: 'TES tank area',
                },
                {
                  key: '10',
                  component: 'Bơm nước lạnh (P1A/P1B)',
                  function: 'Bơm nước lạnh chính',
                  location: 'Pump room',
                },
                {
                  key: '11',
                  component: 'Bơm bù áp (booster pumps)',
                  function: 'Duy trì áp suất hệ thống',
                  location: 'Pump room',
                },
              ]}
              columns={[
          ...
          <Card title='Đặc điểm kỹ thuật nổi bật TTDL Vân Canh' style={{ marginBottom: '20px' }}>
            <Paragraph>
              <ul>
                <li>
                  <Text strong>Hệ thống TES Tank:</Text> Dự phòng 10 phút với 4 chế độ
                  (Commissioning, Normal, Charge, Discharge)
                </li>
                <li>
                  <Text strong>SMARDT Chiller Integration:</Text> Điều khiển Oil-free Chiller 632kW
                  (180RT)
                </li>
                <li>
                  <Text strong>Load Balancing:</Text> Tự động gọi thêm/cắt bớt Chiller theo tải DC
                  (&gt;80% gọi thêm, &lt;60% cắt bớt)
                </li>
                <li>
                  <Text strong>UNIFLAIR PAC Control:</Text> Quản lý SDCV/LDCV Series qua Modbus RTU
                </li>
                <li>
                  <Text strong>Emergency Response:</Text> Tự động chuyển sang chế độ Discharge khi
                  mất điện
                </li>
                <li>
                  <Text strong>Temperature Control:</Text> Duy trì 10°C nước lạnh cấp, 16°C nước hồi
                </li>
                <li>
                  <Text strong>Pump Management:</Text> Điều khiển biến tần bơm theo chênh lệch áp
                  suất
                </li>
                <li>
                  <Text strong>Rotation Control:</Text> Vận hành luân phiên Chiller mỗi 8 giờ
                </li>
                <li>
                  <Text strong>Real-time Monitoring:</Text> Giám sát 24/7 với báo cáo tự động
                </li>
                <li>
                  <Text strong>Bypass System:</Text> Van bypass tự động duy trì áp suất tối thiểu
                </li>
              </ul>
            </Paragraph>
          </Card>
          ...
          <Card title='Các chế độ vận hành TES Tank' style={{ marginBottom: '20px' }}>
            <Title level={4} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
              1. Chế độ Commissioning (Khởi tạo)
            </Title>
            <Paragraph>
              <ul>
                <li>
                  <Tag color='green'>Van V2A, V2B, V3A, V3B: MỞ</Tag>
                </li>
                <li>
                  <Tag color='red'>Van V1A, V1B: ĐÓNG</Tag>
                </li>
            ...
            <Title level={4} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
              2. Chế độ Normal (Bình thường)
            </Title>
            <Paragraph>
              <ul>
                <li>
                  <Tag color='green'>Van V1A, V1B: MỞ</Tag>
                </li>
                <li>
                  <Tag color='red'>Van V2A, V2B, V3A, V3B: ĐÓNG</Tag>
                </li>
            ...
            <Title level={4} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
              3. Chế độ Charge (Nạp lạnh)
            </Title>
            <Paragraph>
              <ul>
                <li>
                  <Tag color='orange'>Van V2A, V2B: Điều tiết theo tải (tối thiểu 10%)</Tag>
                </li>
                <li>
                  <Tag color='green'>Van V3A, V3B: MỞ 100%</Tag>
                </li>
                <li>
                  <Tag color='red'>Van V1A, V1B: ĐÓNG</Tag>
                </li>
            ...
            <Title level={4} style={{ color: '#595959', marginBottom: '8px', fontSize: '16px' }}>
              4. Chế độ Discharge (Xả lạnh)
            </Title>
            <Paragraph>
              <ul>
                <li>Kích hoạt khi Chiller tắt (hỏng hóc/mất nguồn)</li>
                <li>
                  TES Tank cung cấp nước lạnh 10°C trong <Text strong>10 phút</Text>
                </li>
        ...
        <div id='section-2.5.3' className='subsection'>
          <Title level={4}>
            <ToolOutlined style={{ marginRight: '8px' }} /> 2.5.3. Hướng dẫn vận hành và kiểm tra
            hàng ngày
          </Title>
          ...
          <Card title='Kiểm tra hàng ngày' style={{ marginBottom: '20px' }}>
            ...
            <Table
              dataSource={[
                {
                  key: '1',
                  parameter: 'Trạng thái PLC',
                  normal: 'Online',
                  check: 'Kiểm tra đèn LED',
                },
                {
                  key: '2',
                  parameter: 'Kết nối HMI',
                  normal: 'Connected',
                  check: 'Kiểm tra màn hình',
                },
                {
                  key: '3',
                  parameter: 'Giao tiếp Modbus',
                  normal: 'OK',
                  check: 'Kiểm tra trạng thái',
                },
                {
                  key: '4',
                  parameter: 'Dữ liệu cảm biến',
                  normal: 'Valid',
                  check: 'Kiểm tra giá trị',
                },
                {
                  key: '5',
                  parameter: 'Trạng thái thiết bị',
                  normal: 'Running',
                  check: 'Kiểm tra từ xa',
                },
                { key: '6', parameter: 'Báo cáo lỗi', normal: 'No Error', check: 'Kiểm tra log' },
                {
                  key: '7',
                  parameter: 'Backup dữ liệu',
                  normal: 'Success',
                  check: 'Kiểm tra backup',
                },
              ]}
              columns={[
                {
        ...
        <div id='section-2.5.4' className='subsection'>
          <Title level={4}>
            <ExclamationCircleOutlined style={{ marginRight: '8px' }} /> 2.5.4. Hướng dẫn xác định
            nguyên nhân lỗi
          </Title>
