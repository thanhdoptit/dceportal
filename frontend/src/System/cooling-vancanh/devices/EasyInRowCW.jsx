    ...
    <div>
      <div id='section-2-4' className='subsection'>
        ...
        <div id='section-2.4.1' className='subsection'>
          ...
          <Card title='Đặc điểm kỹ thuật nổi bật' style={{ marginBottom: '20px' }}>
            <Paragraph>
              <ul>
                <li>
                  <Text strong>Làm mát trực tiếp:</Text> Đặt trong hàng rack, làm mát trực tiếp tại
                  nguồn nhiệt
                </li>
                <li>
                  <Text strong>Tiết kiệm không gian:</Text> Thiết kế compact, không chiếm nhiều
                  không gian
                </li>
                <li>
                  <Text strong>Hiệu quả làm mát cao:</Text> Tối ưu hiệu quả làm mát cho từng rack
                </li>
                <li>
                  <Text strong>Dễ dàng mở rộng:</Text> Có thể thêm thiết bị khi cần mở rộng
                </li>
                <li>
                  <Text strong>Tiết kiệm năng lượng:</Text> Chỉ làm mát khi cần thiết
                </li>
                <li>
                  <Text strong>Tích hợp BMS:</Text> Giao tiếp Modbus, tích hợp hệ thống giám sát
                </li>
              </ul>
            </Paragraph>
          </Card>
        ...
        <div id='section-2.4.3' className='subsection'>
          <Title level={4}>
            <ToolOutlined style={{ marginRight: '8px' }} /> 2.4.3. Hướng dẫn vận hành và kiểm tra
            hàng ngày
          </Title>
          ...
          <Card title='Kiểm tra hàng ngày' style={{ marginBottom: '20px' }}>
            ...
            <Table
              dataSource={[
                {
                  key: '1',
                  parameter: 'Nhiệt độ nước vào',
                  normal: '7°C',
                  check: 'Đọc cảm biến nhiệt độ',
                },
                {
                  key: '2',
                  parameter: 'Nhiệt độ nước ra',
                  normal: '12°C',
                  check: 'Đọc cảm biến nhiệt độ',
                },
                {
                  key: '3',
                  parameter: 'Áp suất nước',
                  normal: '2-4 bar',
                  check: 'Đọc đồng hồ áp suất',
                },
                {
                  key: '4',
                  parameter: 'Lưu lượng nước',
                  normal: '3.6 m³/h',
                  check: 'Đọc đồng hồ lưu lượng',
                },
                {
                  key: '5',
                  parameter: 'Tốc độ quạt',
                  normal: 'Theo thiết kế',
                  check: 'Kiểm tra tín hiệu quạt',
                },
                {
                  key: '6',
                  parameter: 'Nhiệt độ không khí ra',
                  normal: '16-18°C',
                  check: 'Đọc cảm biến nhiệt độ',
                },
                {
                  key: '7',
                  parameter: 'Rò rỉ nước',
                  normal: 'Không có',
                  check: 'Kiểm tra trực quan',
                },
              ]}
              columns={[
                {
