...
import { Typography, Table, Card, Alert, Tag, Input, Space, Divider, Collapse } from 'antd';
import { 
...
const ErrorCodesGuide = () => {
  ...
  // Filter function
  const filteredCodes = allErrorCodes.filter(error => 
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 100,
      render: (text) => (
        <Tag color={text === 'Có' ? 'green' : 'red'} icon={text === 'Có' ? <CheckCircleOutlined /> : <CloseCircleOutlined />}>
          {text}
        </Tag>
      ),
    },
  ...
  return (
    <div style={{ padding: '20px 0' }}>
        ...
        <Panel header="⚠️ Quy trình xử lý sự cố" key="procedure">
          <div>
            <Paragraph>
              ...
              <ul>
                <li><Tag color="red">Nghiêm trọng</Tag>: Tắt máy ngay lập tức, liên hệ kỹ thuật</li>
                <li><Tag color="orange">Cao</Tag>: Theo dõi sát, chuẩn bị phương án</li>
                <li><Tag color="yellow">Trung bình</Tag>: Xử lý trong ca, báo cáo</li>
                <li><Tag color="green">Thấp</Tag>: Ghi nhận, xử lý khi có thời gian</li>
              </ul>
            </Paragraph>
      ...
      <Alert
        ...
        description={
          <div>
            <p><strong>Lỗi nghiêm trọng:</strong> Liên hệ ngay Trưởng ca và Kỹ thuật HVAC</p>
            <p><strong>SMARDT Service:</strong> APC Industry - 028.3722.3600</p>
            <p><strong>UNIFLAIR Service:</strong> Schneider Electric - 028.3823.9575</p>
            <p><strong>24/7 Support:</strong> Hotline Data Center - 1900.xxxx</p>
          </div>
        }
        type="error"
        showIcon
