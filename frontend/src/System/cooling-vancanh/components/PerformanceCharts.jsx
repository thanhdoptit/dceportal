...
import { Alert, Card, Divider, Space, Table, Tabs, Tag, Typography } from 'antd';
    ...
    <div style={{ padding: '20px 0' }}>
              ...
              <Card>
                ...
                <div style={{ marginTop: '20px' }}>
                  ...
                  <Space direction='vertical' size='small'>
                    <Text>
                      • <strong>COP tối ưu:</strong> 14.80 tại tải 25% (tiết kiệm năng lượng tối đa)
                    </Text>
                    <Text>
                      • <strong>COP full load:</strong> 3.238 tại tải 100% (điều kiện thiết kế)
                    </Text>
                    <Text>
                      • <strong>Vùng vận hành tối ưu:</strong> 40-75% tải (COP 5.0-11.14)
                    </Text>
                    <Text>
                      • <strong>Sound level:</strong> Giảm từ 69.0 dB(A) xuống 57.3 dB(A) theo tải
                    </Text>
                    <Text>
                      • <strong>Công suất tiêu thụ:</strong> Từ 194.6 kW (100%) xuống 6.557 kW (10%)
                    </Text>
                  </Space>
                </div>
              </Card>
          ...
          },
          {
            ...
            children: (
              <Card>
                ...
                <div style={{ marginTop: '20px' }}>
                  <Title level={4} style={{ color: '#595959' }}>
                    Đặc điểm kỹ thuật UNIFLAIR:
                  </Title>
                  <Space direction='vertical' size='small'>
                    <Text>
                      • <strong>LDCV0600A:</strong> 16.8kW - Phòng server nhỏ, EER cao nhất 38.6
                    </Text>
                    <Text>
                      • <strong>LDCV1800A:</strong> 64.4kW - Phòng server trung bình
                    </Text>
                    <Text>
                      • <strong>LDCV3400A:</strong> 79.8kW - Phòng server lớn
                    </Text>
                    <Text>
                      • <strong>LDCV4300A:</strong> 110.0kW - Phòng server rất lớn
                    </Text>
                    <Text>
                      • <strong>SHR:</strong> 94-98% (tỷ lệ nhiệt hiển cao, phù hợp IT load)
                    </Text>
                  </Space>
                </div>
              </Card>
            ...
            children: (
              <Card>
                ...
                <div style={{ marginTop: '20px' }}>
                  ...
                  <Space direction='vertical' size='small'>
                    <Text>
                      • <strong>Tần số cao nhất:</strong> 1000 Hz (65.2 dB @ 100% load)
                    </Text>
                    <Text>
                      • <strong>Tần số thấp nhất:</strong> 63 Hz (46.7 dB @ 100% load)
                    </Text>
                    <Text>
                      • <strong>Giảm âm theo tải:</strong> ~7-8 dB khi giảm từ 100% xuống 25%
                    </Text>
                    <Text>
                      • <strong>Tần số ảnh hưởng nhiều:</strong> 500-2000 Hz (phạm vi nghe rõ nhất)
                    </Text>
                    <Text>
                      • <strong>Khuyến nghị:</strong> Vận hành &lt;75% load để giảm tiếng ồn
                    </Text>
                  </Space>
                </div>
              </Card>
      ...
      <Alert
        ...
        description={
          <div>
            <p>
              <strong>SMARDT Chiller:</strong> Vận hành ở 40-60% tải để đạt COP cao (6.5-8.3) và
              giảm tiếng ồn.
            </p>
            <p>
              <strong>UNIFLAIR PAC:</strong> Sử dụng nhiều unit nhỏ thay vì ít unit lớn để tăng độ
              dự phòng.
            </p>
            <p>
              <strong>Tổng thể:</strong> Load balancing giữa các thiết bị để tối ưu hiệu suất và
              tuổi thọ.
            </p>
          </div>
        }
