...
const HVACSystemDiagram = () => {
  ...
  const floorData = {
    ...
    tang3: {
      ...
      equipment: ['Khu vực văn phòng', 'Phòng Hub (Hub Room)', 'Hệ thống thông gió và hút khói'],
      color: '#52c41a',
    },
    tang2: {
    ...
    <div style={{ padding: '20px 0' }}>
      <Card>
        ...
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          ...
          >
            ...
            <text
              ...
              fontSize='14'
              fontWeight='bold'
              fill={selectedFloor === 'tangThuong' ? 'white' : '#1890ff'}
            >
              Tầng thượng
            </text>
            <text
            ...
            <text
              ...
              fontSize='14'
              fontWeight='bold'
              fill={selectedFloor === 'tang3' ? 'white' : '#52c41a'}
            >
              Tầng 3
            </text>
            <text
            ...
            <text
              ...
              fontSize='14'
              fontWeight='bold'
              fill={selectedFloor === 'tang2' ? 'white' : '#13c2c2'}
            >
              Tầng 2
            </text>
            <text
            ...
            <text
              ...
              fontSize='14'
              fontWeight='bold'
              fill={selectedFloor === 'tang1' ? 'white' : '#f5222d'}
            >
              Tầng 1 - DC Hall
            </text>
            <text
              ...
              fill={selectedFloor === 'tang1' ? 'white' : '#f5222d'}
            >
              Điện A/B, Ác quy A/B, IPS A/B, HUD, Giám sát an ninh, PCCC
            </text>
            <text
              x='500'
              y='340'
            ...
            <text x='50' y='90' fontSize='12' fontWeight='bold' fill='#1890ff'>
              ❄️ Chiller System
            </text>
            <text x='50' y='110' fontSize='10' fill='#666'>
              • 3×632kW/180RT Air-cooled
            </text>
            <text x='50' y='125' fontSize='10' fill='#666'>
              • SMARDT AE Series Oil-free
            </text>
            <text x='50' y='140' fontSize='10' fill='#666'>
              • 2 running, 1 backup (N+1)
            </text>

            <text x='750' y='90' fontSize='12' fontWeight='bold' fill='#52c41a'>
              🌊 Pump System
            </text>
            <text x='750' y='110' fontSize='10' fill='#666'>
              • 3×25.3 L/s, 40mH2O
            </text>
            <text x='750' y='125' fontSize='10' fill='#666'>
              • 22kW each, VFD control
            </text>
            <text x='750' y='140' fontSize='10' fill='#666'>
              • 2 running, 1 standby (2N+1)
            </text>

            <text x='50' y='200' fontSize='12' fontWeight='bold' fill='#faad14'>
              🏭 PAU System
            </text>
            <text x='50' y='220' fontSize='10' fill='#666'>
              • 1×850 L/s
            </text>
            <text x='50' y='235' fontSize='10' fill='#666'>
              • Xử lý không khí tươi
            </text>

            <text x='750' y='200' fontSize='12' fontWeight='bold' fill='#f5222d'>
              🏢 CRAC Systems
            </text>
            <text x='750' y='220' fontSize='10' fill='#666'>
              • 8×DCH: 102.8kW/32RT
            </text>
            <text x='750' y='235' fontSize='10' fill='#666'>
              • 6×INROW: 21.6kW
            </text>
            <text x='750' y='250' fontSize='10' fill='#666'>
              • 4×ER: 64.4-79.8kW
            </text>
            <text x='750' y='265' fontSize='10' fill='#666'>
              • 4×BR: 9.5-15.6kW
            </text>

            {/* TES Tank */}
            <circle cx='150' cy='390' r='25' fill='#13c2c2' stroke='#13c2c2' strokeWidth='2' />
            <text x='150' y='395' textAnchor='middle' fontSize='10' fontWeight='bold' fill='white'>
              TES
            </text>
            <text x='150' y='425' textAnchor='middle' fontSize='10' fill='#13c2c2'>
              Bể TES
            </text>
            ...
            <text x='50' y='520' fontSize='11' fontWeight='bold' fill='#1890ff'>
              🌡️ Nước lạnh:
            </text>
            <text x='50' y='535' fontSize='10' fill='#666'>
              • Cấp: 12°C
            </text>
            <text x='50' y='550' fontSize='10' fill='#666'>
              • Hồi: 18°C
            </text>

            <text x='750' y='520' fontSize='11' fontWeight='bold' fill='#f5222d'>
              ⚡ Tổng công suất:
            </text>
            <text x='750' y='535' fontSize='10' fill='#666'>
              • Làm lạnh: ~1,896kW
            </text>
            <text x='750' y='550' fontSize='10' fill='#666'>
              • Dự phòng: N+1 cho Chiller, 2N+1 cho bơm
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <Row gutter={[16, 8]}>
            <Col span={12}>
              <span style={{ color: '#000000' }}>⬇️</span> <strong>Đường nước lạnh chính</strong> -
              Từ tầng thượng xuống các tầng
            </Col>
            <Col span={12}>
              <span style={{ color: '#13c2c2' }}>🔵</span> <strong>Đường kết nối TES</strong> - Nước
              từ bể TES lên tầng thượng
            </Col>
            <Col span={12}>
          ...
          <div style={{ marginTop: '12px', fontSize: '12px', color: '#666' }}>
            💡 <strong>Lưu ý:</strong> Click vào từng tầng để xem chi tiết thiết bị. Hệ thống được
            thiết kế với độ dự phòng N+1 cho Chiller và 2N+1 cho bơm để đảm bảo hoạt động liên tục
            24/7. Tổng công suất làm lạnh ~1,896kW.
          </div>
        </div>
      </Card>
    </div>
