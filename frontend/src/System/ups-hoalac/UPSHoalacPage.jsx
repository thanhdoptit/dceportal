...
const SECTIONS = [
  ...
  },
  {
    ...
    submenu: [
      {
        key: 'fire-1',
        label: 'Hệ thống PCCC tự động bằng khí Novec 1230',
...
function Sidebar({
  ...
  return (
    <nav
      className={`sticky top-20 w-full max-w-sm space-y-1 z-10 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-slate-200 mx-auto lg:mx-0 ${
    ...
    <div className='min-h-screen bg-slate-100'>
          ...
          <div className='flex items-center gap-4'>
            ...
            <div>
              <h1 className='text-lg font-bold text-slate-900'>
                Tài liệu Trung tâm Dữ liệu Vân Canh
              </h1>
              <p className='text-xs text-slate-500'>
                Tổng quan • Kiến trúc • Điện • Làm mát • An ninh • Mạng • Rack • PCCC • Rủi ro
              </p>
            </div>
          </div>
      ...
      <div className='max-w-8xl mx-auto px-6 py-8'>
        ...
        {mobileMenuOpen && (
          ...
          >
            <div
              className='absolute top-0 left-0 w-80 h-full bg-white shadow-xl'
